...
class StringsKt__StringBuilderKt extends StringsKt__StringBuilderJVMKt {
    ...
    public static final StringBuilder append(StringBuilder sb, String... strArr) {
        Intrinsics.checkNotNullParameter(sb, "<this>");
        Intrinsics.checkNotNullParameter(strArr, AppMeasurementSdk.ConditionalUserProperty.VALUE);
    ...
    public static final StringBuilder append(StringBuilder sb, Object... objArr) {
        Intrinsics.checkNotNullParameter(sb, "<this>");
        Intrinsics.checkNotNullParameter(objArr, AppMeasurementSdk.ConditionalUserProperty.VALUE);
    ...
    private static final StringBuilder appendLine(StringBuilder sb, char[] cArr) {
        Intrinsics.checkNotNullParameter(sb, "<this>");
        Intrinsics.checkNotNullParameter(cArr, AppMeasurementSdk.ConditionalUserProperty.VALUE);
        sb.append(cArr);
        Intrinsics.checkNotNullExpressionValue(sb, "append(value)");
        sb.append(10);
        Intrinsics.checkNotNullExpressionValue(sb, "append('\\n')");
