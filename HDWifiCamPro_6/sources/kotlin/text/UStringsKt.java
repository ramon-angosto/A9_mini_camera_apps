...
public final class UStringsKt {
    ...
    public static final String m1298toStringLxnNnR4(byte b, int i) {
    ...
    public static final String m1300toStringolVBNx4(short s, int i) {
    ...
    public static final String m1299toStringV7xB4Y4(int i, int i2) {
    ...
    public static final String m1297toStringJSWoG40(long j, int i) {
    ...
    public static final UByte toUByteOrNull(String str, int i) {
        ...
        int r1 = uIntOrNull.m149unboximpl();
        if (UnsignedKt.uintCompare(r1, UInt.m98constructorimpl(255)) > 0) {
            return null;
        }
    ...
    public static final UShort toUShortOrNull(String str, int i) {
        ...
        int r1 = uIntOrNull.m149unboximpl();
        if (UnsignedKt.uintCompare(r1, UInt.m98constructorimpl(65535)) > 0) {
            return null;
        }
        return UShort.m276boximpl(UShort.m282constructorimpl((short) r1));
    }
    ...
    public static final UInt toUIntOrNull(String str, int i) {
        ...
        int r5 = UInt.m98constructorimpl(i);
        int i4 = 119304647;
        while (i3 < length) {
            ...
            int r3 = UInt.m98constructorimpl(i2 * r5);
            int r8 = UInt.m98constructorimpl(UInt.m98constructorimpl(digitOf) + r3);
    ...
    public static final ULong toULongOrNull(String str, int i) {
        ...
        long r9 = ULong.m176constructorimpl((long) i2);
        long j2 = 0;
        ...
        while (i3 < length) {
            ...
            long r11 = ULong.m176constructorimpl(j2 * r9);
            long r4 = ULong.m176constructorimpl(ULong.m176constructorimpl(((long) UInt.m98constructorimpl(digitOf)) & 4294967295L) + r11);
