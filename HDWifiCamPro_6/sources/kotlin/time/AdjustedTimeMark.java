...
final class AdjustedTimeMark implements TimeMark {
    ...
    public TimeMark m1309minusLRDsOJo(long j) {
        return TimeMark.DefaultImpls.m1453minusLRDsOJo(this, j);
    }

    /* renamed from: getAdjustment-UwyO8pc  reason: not valid java name */
    public final long m1308getAdjustmentUwyO8pc() {
    ...
    public long m1307elapsedNowUwyO8pc() {
        return Duration.m1350minusLRDsOJo(this.mark.m1450elapsedNowUwyO8pc(), this.adjustment);
    }

    /* renamed from: plus-LRDsOJo  reason: not valid java name */
    public TimeMark m1310plusLRDsOJo(long j) {
        return new AdjustedTimeMark(this.mark, Duration.m1351plusLRDsOJo(this.adjustment, j), (DefaultConstructorMarker) null);
    }
}
