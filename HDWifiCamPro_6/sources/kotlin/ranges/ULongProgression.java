...
public class ULongProgression implements Iterable<ULong>, KMappedMarker {
    ...
    public int hashCode() {
        ...
        long j2 = this.last;
        long j3 = this.step;
        return (((((int) ULong.m176constructorimpl(j ^ ULong.m176constructorimpl(j >>> 32))) * 31) + ((int) ULong.m176constructorimpl(j2 ^ ULong.m176constructorimpl(j2 >>> 32)))) * 31) + ((int) ((j3 >>> 32) ^ j3));
    }
