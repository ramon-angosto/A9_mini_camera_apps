                                                    ...
                                                    if (!(t instanceof UByteArray) || !(t2 instanceof UByteArray)) {
                                                        if (!(t instanceof UShortArray) || !(t2 instanceof UShortArray)) {
                                                            if (!(t instanceof UIntArray) || !(t2 instanceof UIntArray)) {
                                                                ...
                                                                } else if (!UArraysKt.m568contentEqualslec5QzE(((ULongArray) t).m244unboximpl(), ((ULongArray) t2).m244unboximpl())) {
                                                                    return false;
                                                                }
                                                            } else if (!UArraysKt.m564contentEqualsKJPZfPQ(((UIntArray) t).m166unboximpl(), ((UIntArray) t2).m166unboximpl())) {
                                                                return false;
                                                            }
                                                        } else if (!UArraysKt.m563contentEqualsFGO6Aew(((UShortArray) t).m348unboximpl(), ((UShortArray) t2).m348unboximpl())) {
                                                            return false;
                                                        }
                                                    } else if (!UArraysKt.m566contentEqualskV0jMPg(((UByteArray) t).m88unboximpl(), ((UByteArray) t2).m88unboximpl())) {
                                                        return false;
                                                    }
