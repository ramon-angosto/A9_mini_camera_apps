...
public final class UnsignedKt {
    ...
    public static final int m351uintDivideJ1ME1BU(int i, int i2) {
        return UInt.m98constructorimpl((int) ((((long) i) & 4294967295L) / (((long) i2) & 4294967295L)));
    }
    ...
    public static final long m353ulongDivideeb3DHEI(long j, long j2) {
        if (j2 < 0) {
            return ulongCompare(j, j2) < 0 ? ULong.m176constructorimpl(0) : ULong.m176constructorimpl(1);
        }
        if (j >= 0) {
            return ULong.m176constructorimpl(j / j2);
        }
        int i = 1;
        long j3 = ((j >>> 1) / j2) << 1;
        if (ulongCompare(ULong.m176constructorimpl(j - (j3 * j2)), ULong.m176constructorimpl(j2)) < 0) {
            i = 0;
        }
        return ULong.m176constructorimpl(j3 + ((long) i));
    }

    /* renamed from: ulongRemainder-eb3DHEI  reason: not valid java name */
    public static final long m354ulongRemaindereb3DHEI(long j, long j2) {
        if (j2 < 0) {
            return ulongCompare(j, j2) < 0 ? j : ULong.m176constructorimpl(j - j2);
        }
        if (j >= 0) {
            return ULong.m176constructorimpl(j % j2);
        }
        long j3 = j - ((((j >>> 1) / j2) << 1) * j2);
        if (ulongCompare(ULong.m176constructorimpl(j3), ULong.m176constructorimpl(j2)) < 0) {
            j2 = 0;
        }
        return ULong.m176constructorimpl(j3 - j2);
    }
    ...
    public static final int doubleToUInt(double d) {
        ...
        return UInt.m98constructorimpl(UInt.m98constructorimpl((int) (d - ((double) Integer.MAX_VALUE))) + UInt.m98constructorimpl(Integer.MAX_VALUE));
    }
    ...
    public static final long doubleToULong(double d) {
        ...
        if (d < 9.223372036854776E18d) {
            return ULong.m176constructorimpl((long) d);
        }
        return ULong.m176constructorimpl(ULong.m176constructorimpl((long) (d - 9.223372036854776E18d)) - Long.MIN_VALUE);
    }
