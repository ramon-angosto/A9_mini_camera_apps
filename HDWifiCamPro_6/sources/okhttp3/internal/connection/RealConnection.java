...
public final class RealConnection extends Http2Connection.Listener implements Connection {
    ...
    private void connectTls(okhttp3.internal.connection.ConnectionSpecSelector r8) throws java.io.IOException {
        ...
        L_0x00f9:
            ...
            okio.Source r8 = okio.Okio.source((java.net.Socket) r8)     // Catch:{ AssertionError -> 0x012c, all -> 0x012a }
            okio.BufferedSource r8 = okio.Okio.buffer((okio.Source) r8)     // Catch:{ AssertionError -> 0x012c, all -> 0x012a }
            r7.source = r8     // Catch:{ AssertionError -> 0x012c, all -> 0x012a }
            java.net.Socket r8 = r7.socket     // Catch:{ AssertionError -> 0x012c, all -> 0x012a }
            okio.Sink r8 = okio.Okio.sink((java.net.Socket) r8)     // Catch:{ AssertionError -> 0x012c, all -> 0x012a }
            okio.BufferedSink r8 = okio.Okio.buffer((okio.Sink) r8)     // Catch:{ AssertionError -> 0x012c, all -> 0x012a }
