...
public class LogThreadPoolManager {
    ...
    /* access modifiers changed from: private */
    public final ThreadPoolExecutor mThreadPool = new ThreadPoolExecutor(1, 1, DefaultRenderersFactory.DEFAULT_ALLOWED_VIDEO_JOINING_TIME_MS, TimeUnit.MILLISECONDS, new ArrayBlockingQueue(SIZE_WORK_QUEUE), new ThreadFactory() {
