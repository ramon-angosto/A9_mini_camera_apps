...
public class ResumableDownloadTask<Requst extends ResumableDownloadRequest, Result extends ResumableDownloadResult> implements Callable<Result> {
    ...
    public void downloadPart(com.alibaba.sdk.android.oss.internal.ResumableDownloadTask<Requst, Result>.DownloadFileResult r13, com.alibaba.sdk.android.oss.internal.ResumableDownloadTask.DownloadPart r14) {
        ...
        L_0x0016:
            ...
            int r5 = (int) r5     // Catch:{ Exception -> 0x0160, all -> 0x015e }
            byte[] r5 = new byte[r5]     // Catch:{ Exception -> 0x0160, all -> 0x015e }
            com.alibaba.sdk.android.oss.model.ResumableDownloadRequest r6 = r12.mRequest     // Catch:{ Exception -> 0x0160, all -> 0x015e }
        ...
        L_0x007f:
            ...
            r8 = 0
            int r6 = (int) r6     // Catch:{ Exception -> 0x0160, all -> 0x015e }
            r1.write(r5, r8, r6)     // Catch:{ Exception -> 0x0160, all -> 0x015e }
            goto L_0x007f
        L_0x0090:
    ...
    static class CheckPoint implements Serializable {
        ...
        /* Code decompiled incorrectly, please refer to instructions dump. */
        public synchronized void dump(java.lang.String r5) throws java.io.IOException {
            /*
                r4 = this;
                monitor-enter(r4)
                int r0 = r4.hashCode()     // Catch:{ all -> 0x004d }
                r4.md5 = r0     // Catch:{ all -> 0x004d }
                java.io.File r0 = new java.io.File     // Catch:{ all -> 0x004d }
                java.lang.StringBuilder r1 = new java.lang.StringBuilder     // Catch:{ all -> 0x004d }
                r1.<init>()     // Catch:{ all -> 0x004d }
                r1.append(r5)     // Catch:{ all -> 0x004d }
                ...
                java.io.ObjectOutputStream r3 = new java.io.ObjectOutputStream     // Catch:{ all -> 0x003e }
                r3.<init>(r2)     // Catch:{ all -> 0x003e }
                r3.writeObject(r4)     // Catch:{ all -> 0x003b }
                java.io.File r1 = new java.io.File     // Catch:{ all -> 0x003b }
                r1.<init>(r5)     // Catch:{ all -> 0x003b }
                r0.renameTo(r1)     // Catch:{ all -> 0x003b }
         ...
         */
        /* Code decompiled incorrectly, please refer to instructions dump. */
        public synchronized boolean isValid(com.alibaba.sdk.android.oss.internal.InternalRequestOperation r6) throws com.alibaba.sdk.android.oss.ClientException, com.alibaba.sdk.android.oss.ServiceException {
            /*
                r5 = this;
                monitor-enter(r5)
                int r0 = r5.md5     // Catch:{ all -> 0x005a }
                int r1 = r5.hashCode()     // Catch:{ all -> 0x005a }
                r2 = 0
                if (r0 == r1) goto L_0x000c
                monitor-exit(r5)
                return r2
            L_0x000c:
                java.lang.String r0 = r5.bucketName     // Catch:{ all -> 0x005a }
                java.lang.String r1 = r5.objectKey     // Catch:{ all -> 0x005a }
                com.alibaba.sdk.android.oss.internal.ResumableDownloadTask$FileStat r6 = com.alibaba.sdk.android.oss.internal.ResumableDownloadTask.FileStat.getFileStat(r6, r0, r1)     // Catch:{ all -> 0x005a }
                com.alibaba.sdk.android.oss.internal.ResumableDownloadTask$FileStat r0 = r5.fileStat     // Catch:{ all -> 0x005a }
                java.util.Date r0 = r0.lastModified     // Catch:{ all -> 0x005a }
                if (r0 != 0) goto L_0x0032
                com.alibaba.sdk.android.oss.internal.ResumableDownloadTask$FileStat r0 = r5.fileStat     // Catch:{ all -> 0x005a }
                long r0 = r0.fileLength     // Catch:{ all -> 0x005a }
                long r3 = r6.fileLength     // Catch:{ all -> 0x005a }
                int r0 = (r0 > r3 ? 1 : (r0 == r3 ? 0 : -1))
                if (r0 != 0) goto L_0x0030
                com.alibaba.sdk.android.oss.internal.ResumableDownloadTask$FileStat r0 = r5.fileStat     // Catch:{ all -> 0x005a }
                java.lang.String r0 = r0.etag     // Catch:{ all -> 0x005a }
                java.lang.String r6 = r6.etag     // Catch:{ all -> 0x005a }
                boolean r6 = r0.equals(r6)     // Catch:{ all -> 0x005a }
            ...
            L_0x0032:
                ...
                com.alibaba.sdk.android.oss.internal.ResumableDownloadTask$FileStat r0 = r5.fileStat     // Catch:{ all -> 0x005a }
                java.util.Date r0 = r0.lastModified     // Catch:{ all -> 0x005a }
                java.util.Date r1 = r6.lastModified     // Catch:{ all -> 0x005a }
    ...
    static class FileStat implements Serializable {
        ...
        public static FileStat getFileStat(InternalRequestOperation internalRequestOperation, String str, String str2) throws ClientException, ServiceException {
            GetObjectMetaResult result = internalRequestOperation.getObjectMeta(new GetObjectMetaRequest(str, str2), (OSSCompletedCallback<GetObjectMetaRequest, GetObjectMetaResult>) null).getResult();
