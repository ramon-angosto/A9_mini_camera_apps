...
public class a {
    ...
    private final HashMap<View, C0080a> b = new HashMap<>();
    ...
    private void a(c cVar, com.iab.omid.library.ironsrc.adsession.a aVar) {
        ...
        if (view != null) {
            C0080a aVar2 = this.b.get(view);
            if (aVar2 != null) {
                aVar2.a(aVar.getAdSessionId());
            } else {
                this.b.put(view, new C0080a(cVar, aVar.getAdSessionId()));
            }
        }
    }
