...
public class b extends AdSessionStatePublisher {
    ...
    public void a(a aVar, AdSessionContext adSessionContext) {
        ...
        for (String next : injectedResourcesMap.keySet()) {
            com.iab.omid.library.vungle.d.b.a(jSONObject, next, injectedResourcesMap.get(next));
        }
    ...
    public void b() {
        ...
        new Handler().postDelayed(new Runnable() {
            private final WebView b = b.this.a;
    ...
    public void j() {
        this.a = new WebView(com.iab.omid.library.vungle.b.d.a().b());
