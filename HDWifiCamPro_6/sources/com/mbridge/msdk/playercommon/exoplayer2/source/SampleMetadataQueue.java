...
final class SampleMetadataQueue {
    ...
    public final synchronized void commitSample(long r6, int r8, long r9, int r11, com.mbridge.msdk.playercommon.exoplayer2.extractor.TrackOutput.CryptoData r12) {
        ...
        L_0x0015:
            r0 = r1
        L_0x0016:
            com.mbridge.msdk.playercommon.exoplayer2.util.Assertions.checkState(r0)     // Catch:{ all -> 0x00d2 }
            ...
            com.mbridge.msdk.playercommon.exoplayer2.extractor.TrackOutput$CryptoData[] r6 = r5.cryptoDatas     // Catch:{ all -> 0x00d2 }
            r6[r0] = r12     // Catch:{ all -> 0x00d2 }
            com.mbridge.msdk.playercommon.exoplayer2.Format[] r6 = r5.formats     // Catch:{ all -> 0x00d2 }
            com.mbridge.msdk.playercommon.exoplayer2.Format r7 = r5.upstreamFormat     // Catch:{ all -> 0x00d2 }
            ...
            com.mbridge.msdk.playercommon.exoplayer2.extractor.TrackOutput$CryptoData[] r12 = new com.mbridge.msdk.playercommon.exoplayer2.extractor.TrackOutput.CryptoData[r6]     // Catch:{ all -> 0x00d2 }
            com.mbridge.msdk.playercommon.exoplayer2.Format[] r0 = new com.mbridge.msdk.playercommon.exoplayer2.Format[r6]     // Catch:{ all -> 0x00d2 }
            ...
            com.mbridge.msdk.playercommon.exoplayer2.extractor.TrackOutput$CryptoData[] r3 = r5.cryptoDatas     // Catch:{ all -> 0x00d2 }
            int r4 = r5.relativeFirstIndex     // Catch:{ all -> 0x00d2 }
            java.lang.System.arraycopy(r3, r4, r12, r1, r2)     // Catch:{ all -> 0x00d2 }
            com.mbridge.msdk.playercommon.exoplayer2.Format[] r3 = r5.formats     // Catch:{ all -> 0x00d2 }
            int r4 = r5.relativeFirstIndex     // Catch:{ all -> 0x00d2 }
            ...
            com.mbridge.msdk.playercommon.exoplayer2.extractor.TrackOutput$CryptoData[] r4 = r5.cryptoDatas     // Catch:{ all -> 0x00d2 }
            java.lang.System.arraycopy(r4, r1, r12, r2, r3)     // Catch:{ all -> 0x00d2 }
            com.mbridge.msdk.playercommon.exoplayer2.Format[] r4 = r5.formats     // Catch:{ all -> 0x00d2 }
