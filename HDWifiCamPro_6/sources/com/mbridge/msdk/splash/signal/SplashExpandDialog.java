...
public class SplashExpandDialog extends Dialog {
    private final String a = "SplashExpandDialog";
    private String b;
    private boolean c;
    ...
    public void onCreate(Bundle bundle) {
        ...
        setOnDismissListener(new DialogInterface.OnDismissListener() {
            public final void onDismiss(DialogInterface dialogInterface) {
                ...
                SplashExpandDialog.this.e.loadDataWithBaseURL((String) null, "", "text/html", "utf-8", (String) null);
                SplashExpandDialog.this.d.removeView(SplashExpandDialog.this.e);
                SplashExpandDialog.this.e.release();
                WindVaneWebView unused = SplashExpandDialog.this.e = null;
                a unused2 = SplashExpandDialog.this.i = null;
            }
        });
    }
    ...
    static /* synthetic */ void a(SplashExpandDialog splashExpandDialog) {
        SplashExpandDialog splashExpandDialog2 = splashExpandDialog;
        try {
            ...
            int[] iArr = new int[2];
            splashExpandDialog2.e.getLocationInWindow(iArr);
            com.mbridge.msdk.mbsignalcommon.mraid.a.a().a(splashExpandDialog2.e, (float) iArr[0], (float) iArr[1], (float) splashExpandDialog2.e.getWidth(), (float) splashExpandDialog2.e.getHeight());
            com.mbridge.msdk.mbsignalcommon.mraid.a.a().b(splashExpandDialog2.e, (float) iArr[0], (float) iArr[1], (float) splashExpandDialog2.e.getWidth(), (float) splashExpandDialog2.e.getHeight());
            com.mbridge.msdk.mbsignalcommon.mraid.a.a().b(splashExpandDialog2.e, (float) m.h(com.mbridge.msdk.foundation.controller.a.e().g()), (float) m.i(com.mbridge.msdk.foundation.controller.a.e().g()));
            com.mbridge.msdk.mbsignalcommon.mraid.a.a().c(splashExpandDialog2.e, (float) intValue, (float) intValue2);
            com.mbridge.msdk.mbsignalcommon.mraid.a.a().a((WebView) splashExpandDialog2.e, (Map<String, Object>) hashMap);
            com.mbridge.msdk.mbsignalcommon.mraid.a.a().a(splashExpandDialog2.e);
        } catch (Throwable th) {
