...
public class i {
    ...
    public static i a(InputStream inputStream) throws IOException, d {
        BufferedReader bufferedReader = new BufferedReader(new InputStreamReader(inputStream, com.bykv.vk.openvk.component.video.a.c.a.a));
    ...
    static final class a {
        ...
        static a a(c cVar, List<b> list) throws d {
            ...
            if (indexOf != -1) {
                ...
                String str4 = null;
                int i3 = 0;
                for (String split : cVar.b.substring(indexOf + 1).split("&")) {
                ...
                if (list != null) {
                    ...
                    int i5 = 0;
                    for (b next : list) {
                        if (next != null && "Range".equalsIgnoreCase(next.a)) {
                            int indexOf2 = next.b.indexOf("=");
                            if (indexOf2 == -1) {
                                throw new d("Range format error, Range: " + next.b);
                            } else if ("bytes".equalsIgnoreCase(next.b.substring(0, indexOf2).trim())) {
                                String substring = next.b.substring(indexOf2 + 1);
