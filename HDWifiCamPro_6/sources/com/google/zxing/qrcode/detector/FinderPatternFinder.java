        ...
        if (size >= 3) {
            if (size > 3) {
                ...
                for (FinderPattern estimatedModuleSize : this.possibleCenters) {
                    ...
                    d += (double) estimatedModuleSize2;
                    d2 += (double) (estimatedModuleSize2 * estimatedModuleSize2);
                }
                double d3 = (double) size;
                double d4 = d / d3;
                float sqrt = (float) Math.sqrt((d2 / d3) - (d4 * d4));
                float f = (float) d4;
                ...
                while (i < this.possibleCenters.size() && this.possibleCenters.size() > 3) {
                    if (Math.abs(((double) this.possibleCenters.get(i).getEstimatedModuleSize()) - d4) > ((double) max)) {
            ...
            if (this.possibleCenters.size() > 3) {
                ...
                for (FinderPattern estimatedModuleSize3 : this.possibleCenters) {
                    f2 += estimatedModuleSize3.getEstimatedModuleSize();
                }
