...
public final class MaterialContainerTransform extends Transition {
    ...
    private static final class TransitionDrawable extends Drawable {
        ...
        private void updateProgress(float f) {
            ...
            this.currentElevationDy = (float) ((int) (calculateElevationDyMultiplier * f4));
            this.shadowPaint.setShadowLayer(f4, (float) ((int) (calculateElevationDxMultiplier * f4)), this.currentElevationDy, SHADOW_COLOR);
