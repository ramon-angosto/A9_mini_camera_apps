...
public final class zzs {
    public static int zza(int i, int i2, String str) {
        ...
        if (i < 0) {
            str2 = zzy.zza("%s (%s) must not be negative", ImagePagerActivity.INDEX, Integer.valueOf(i));
        } else if (i2 < 0) {
            ...
            str2 = zzy.zza("%s (%s) must be less than size (%s)", ImagePagerActivity.INDEX, Integer.valueOf(i), Integer.valueOf(i2));
        }
    ...
    public static int zzb(int i, int i2, String str) {
        ...
        throw new IndexOutOfBoundsException(zzd(i, i2, ImagePagerActivity.INDEX));
    }
