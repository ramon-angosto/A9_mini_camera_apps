...
interface zzgsz {
    ...
    @Deprecated
    void zzC(List list, zzgth zzgth, zzgqq zzgqq) throws IOException;

    void zzD(List list) throws IOException;

    void zzE(List list) throws IOException;

    void zzF(List list, zzgth zzgth, zzgqq zzgqq) throws IOException;
    ...
    @Deprecated
    Object zzr(zzgth zzgth, zzgqq zzgqq) throws IOException;

    Object zzs(zzgth zzgth, zzgqq zzgqq) throws IOException;
