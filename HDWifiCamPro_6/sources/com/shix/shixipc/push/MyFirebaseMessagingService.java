...
public class MyFirebaseMessagingService extends FirebaseMessagingService {
    ...
    public void onMessageReceived(RemoteMessage remoteMessage) {
        ...
        if (remoteMessage.getNotification() == null) {
            str2 = remoteMessage.getData().get(CampaignEx.JSON_KEY_TITLE);
    ...
    private void sendNotification(String str, String str2) {
        ...
        NotificationCompat.Builder contentIntent = new NotificationCompat.Builder((Context) this, string).setSmallIcon((int) R.mipmap.qh_dev2).setContentTitle(str).setContentText(str2).setAutoCancel(true).setSound(RingtoneManager.getDefaultUri(4)).setContentIntent(activity);
