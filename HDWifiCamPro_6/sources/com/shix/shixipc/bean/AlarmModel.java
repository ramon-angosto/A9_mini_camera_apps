...
public class AlarmModel {
    ...
    public static AlarmModel jsonToModel(String str) throws JSONException {
        ...
        alarmModel.setResult(CommonUtil.jasonPaseInt(jSONObject, IronSourceConstants.EVENTS_RESULT, ContentCommon.SHIXFINAL_ERRORINT));
    ...
    public static String toJson(AlarmModel alarmModel, String str, String str2) throws JSONException {
        ...
        jSONObject.put("AalarmInterval", 2);
        jSONObject.put("pirCloudUpCount", 500);
