    ...
    public final void a(IronSourceError ironSourceError) {
        if (this.a == IronSource.AD_UNIT.INTERSTITIAL) {
            ...
            if (a2.a instanceof RewardedVideoManualListener) {
                c.a.a(new Runnable(ironSourceError) {
                    private /* synthetic */ IronSourceError a;

                    public final void run(
/*
Method generation error in method: com.ironsource.mediationsdk.aa.3.run():void, dex: classes2.dex
                    jadx.core.utils.exceptions.JadxRuntimeException: Method args not loaded: com.ironsource.mediationsdk.aa.3.run():void, class status: UNLOADED
