...
public class RequestHeader implements IMessageEntity {
    ...
    public boolean fromJson(String str) {
        try {
            ...
            this.version = JsonUtil.getStringValue(jSONObject, HiAnalyticsConstant.HaKey.BI_KEY_VERSION);
            ...
            HMSLog.m1377e(TAG, "fromJson failed: " + e.getMessage());
            return false;
        }
    }
    ...
    public String toJson() {
        ...
        try {
            ...
            HMSLog.m1377e(TAG, "toJson failed: " + e.getMessage());
        }
