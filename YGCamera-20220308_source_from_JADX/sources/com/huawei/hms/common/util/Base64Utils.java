    ...
    public static byte[] decode(String str) {
        ...
        if (str != null) {
            try {
                ...
                HMSLog.m1377e(TAG, "decode failed : " + e.getMessage());
            }
        }
        return bArr;
    }
    ...
    public static byte[] decodeUrlSafe(String str) {
        ...
        if (str != null) {
            try {
                ...
                HMSLog.m1377e(TAG, "decodeUrlSafe failed : " + e.getMessage());
            }
        }
        return bArr;
    }
    ...
    public static byte[] decodeUrlSafeNoPadding(String str) {
        ...
        if (str != null) {
            try {
                ...
                HMSLog.m1377e(TAG, "decodeUrlSafeNoPadding failed : " + e.getMessage());
            }
        }
        return bArr;
    }
