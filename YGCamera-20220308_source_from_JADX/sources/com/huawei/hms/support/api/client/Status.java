...
public final class Status extends Result implements Parcelable {
    public static final Parcelable.Creator<Status> CREATOR = new C0906a();
    public static final Status CoreException = new Status(AGCServerException.UNKNOW_EXCEPTION);
    ...
    static class C0906a implements Parcelable.Creator {
        C0906a() {
        }
    ...
    public void startResolutionForResult(Activity activity, int i) throws IntentSender.SendIntentException {
        if (hasResolution()) {
            ...
            if (pendingIntent2 != null) {
                activity.startIntentSenderForResult(pendingIntent2.getIntentSender(), i, (Intent) null, 0, 0, 0);
                return;
            }
