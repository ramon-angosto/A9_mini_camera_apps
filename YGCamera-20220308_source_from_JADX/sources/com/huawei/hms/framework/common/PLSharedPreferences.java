...
public class PLSharedPreferences {
    ...
    /* renamed from: sp */
    private SharedPreferences f445sp;

    public PLSharedPreferences(Context context, String str) {
        this.f445sp = getSharedPreferences(context, str);
    }

    private SharedPreferences getSharedPreferences(Context context, String str) {
        if (context == null) {
            Logger.m471e(TAG, "context is null, must call init method to set context");
            return null;
        }
    ...
    public void clear() {
        SharedPreferences sharedPreferences = this.f445sp;
