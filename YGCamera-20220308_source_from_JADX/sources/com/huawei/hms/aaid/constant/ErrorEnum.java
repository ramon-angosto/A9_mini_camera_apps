...
public enum ErrorEnum {
    ...
    ERROR_API_NOT_SPECIFIED(PointerIconCompat.TYPE_HAND, PointerIconCompat.TYPE_HAND, "API not specified"),
    ...
    public static final SparseArray<ErrorEnum> ENUM_MAPPER = null;
