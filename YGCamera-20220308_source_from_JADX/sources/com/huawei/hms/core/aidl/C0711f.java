...
public class C0711f extends C0710e {
        ...
        for (int i2 = 0; i2 < i; i2++) {
            ...
            if (obj.getClass().isPrimitive() || (obj instanceof String) || (obj instanceof Serializable)) {
                ...
                if (i3 == 1) {
                    ...
                    arrayList.add(mo13637a(bundle2, (IMessageEntity) ((Class) ((ParameterizedType) type).getActualTypeArguments()[0]).newInstance()));
                } else {
    ...
    public void mo13640a(String str, List list, Bundle bundle) {
        ...
        for (int i = 0; i < list.size(); i++) {
            mo13639a("_list_item_" + i, list.get(i), bundle2);
        }
