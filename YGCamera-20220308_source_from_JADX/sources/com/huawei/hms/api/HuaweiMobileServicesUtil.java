...
public abstract class HuaweiMobileServicesUtil {
    ...
    public static Dialog getErrorDialog(int i, Activity activity, int i2) {
        return HuaweiApiAvailability.getInstance().getErrorDialog(activity, i, i2, (DialogInterface.OnCancelListener) null);
    }
    ...
    public static int isHuaweiMobileServicesAvailable(Context context, int i) {
        ...
        HMSLog.m1379i("HuaweiMobileServicesUtil", "hmsPackageName is " + hMSPackageName);
        ...
        if (PackageManagerHelper.PackageStates.NOT_INSTALLED.equals(packageStates)) {
            HMSLog.m1379i("HuaweiMobileServicesUtil", "HMS is not installed");
            return 1;
        } else if (PackageManagerHelper.PackageStates.DISABLED.equals(packageStates)) {
            HMSLog.m1379i("HuaweiMobileServicesUtil", "HMS is disabled");
            return 3;
        } else {
            ...
            HMSLog.m1379i("HuaweiMobileServicesUtil", "connect versionCode:" + hmsVersionCode);
            if (!HMSPackageManager.getInstance(context).isApkUpdateNecessary(i)) {
                return 0;
            }
            HMSLog.m1379i("HuaweiMobileServicesUtil", "The current version does not meet the minimum version requirements");
            return 2;
        }
    }
    ...
    public static boolean showErrorDialogFragment(int i, Activity activity, int i2) {
        return HuaweiApiAvailability.getInstance().showErrorDialogFragment(activity, i, i2, (DialogInterface.OnCancelListener) null);
    }
