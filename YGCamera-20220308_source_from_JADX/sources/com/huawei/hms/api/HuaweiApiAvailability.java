...
public abstract class HuaweiApiAvailability {
    ...
    /* renamed from: a */
    private static final Map<String, Integer> f280a = new HashMap();

    static {
        f280a.put(HMS_API_NAME_ID, 30000000);
        f280a.put(HMS_API_NAME_SNS, 20503000);
        f280a.put(HMS_API_NAME_PAY, 20503000);
        f280a.put(HMS_API_NAME_PUSH, 20503000);
        f280a.put(HMS_API_NAME_GAME, 20503000);
        f280a.put(HMS_API_NAME_OD, Integer.valueOf(HMS_VERSION_CODE_OD));
        f280a.put(HMS_API_NAME_IAP, 20700300);
        f280a.put(HMS_API_NAME_PPS, 20700300);
    }
