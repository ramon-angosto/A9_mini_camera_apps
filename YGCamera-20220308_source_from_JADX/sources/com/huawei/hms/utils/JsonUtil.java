...
public class JsonUtil {
    ...
    public static String createJsonString(IMessageEntity iMessageEntity) {
        if (iMessageEntity == null) {
            HMSLog.m1377e(TAG, "createJsonString error, the input IMessageEntity is null");
            return "";
        }
        try {
            return createInnerJsonString(iMessageEntity);
        } catch (IllegalAccessException e) {
            HMSLog.m1377e(TAG, "catch IllegalAccessException " + e.getMessage());
            return "";
        } catch (JSONException e2) {
            HMSLog.m1377e(TAG, "catch JSONException " + e2.getMessage());
            return "";
        }
    }
        ...
        if (obj instanceof String) {
            ...
            if (obj instanceof IMessageEntity) {
                try {
                    ...
                    HMSLog.m1377e(TAG, "IllegalAccessException , " + e);
                }
            }
            return false;
        }
    ...
    public static Object getInfoFromJsonobject(String str, String str2) {
        if (!TextUtils.isEmpty(str) && !TextUtils.isEmpty(str2)) {
            try {
                ...
                HMSLog.m1377e(TAG, "getInfoFromJsonobject:parser json error :" + str2);
            }
        }
        return null;
    }
    ...
    public static com.huawei.hms.core.aidl.IMessageEntity jsonToEntity(java.lang.String r8, com.huawei.hms.core.aidl.IMessageEntity r9) {
        /*
            ...
            java.lang.Class r1 = r9.getClass()     // Catch:{ JSONException -> 0x0043 }
            org.json.JSONObject r2 = new org.json.JSONObject     // Catch:{ JSONException -> 0x0043 }
            r2.<init>(r8)     // Catch:{ JSONException -> 0x0043 }
        L_0x000b:
            if (r1 == 0) goto L_0x005c
            java.lang.reflect.Field[] r8 = r1.getDeclaredFields()     // Catch:{ JSONException -> 0x0043 }
            int r3 = r8.length     // Catch:{ JSONException -> 0x0043 }
            r4 = 0
        L_0x0013:
            if (r4 >= r3) goto L_0x003e
            r5 = r8[r4]     // Catch:{ JSONException -> 0x0043 }
            java.lang.Class<com.huawei.hms.core.aidl.annotation.Packed> r6 = com.huawei.hms.core.aidl.annotation.Packed.class
            boolean r6 = r5.isAnnotationPresent(r6)     // Catch:{ JSONException -> 0x0043 }
            if (r6 == 0) goto L_0x003b
            readFiled(r9, r5, r2)     // Catch:{ IllegalAccessException -> 0x0023 }
            goto L_0x003b
        L_0x0023:
            java.lang.StringBuilder r6 = new java.lang.StringBuilder     // Catch:{ JSONException -> 0x0043 }
            r6.<init>()     // Catch:{ JSONException -> 0x0043 }
            java.lang.String r7 = "jsonToEntity, set value of the field exception, field name:"
            r6.append(r7)     // Catch:{ JSONException -> 0x0043 }
            java.lang.String r5 = r5.getName()     // Catch:{ JSONException -> 0x0043 }
            r6.append(r5)     // Catch:{ JSONException -> 0x0043 }
            java.lang.String r5 = r6.toString()     // Catch:{ JSONException -> 0x0043 }
            com.huawei.hms.support.log.HMSLog.m1377e(r0, r5)     // Catch:{ JSONException -> 0x0043 }
        L_0x003b:
            int r4 = r4 + 1
            goto L_0x0013
        L_0x003e:
            java.lang.Class r1 = r1.getSuperclass()     // Catch:{ JSONException -> 0x0043 }
            goto L_0x000b
        L_0x0043:
            r8 = move-exception
            ...
            com.huawei.hms.support.log.HMSLog.m1377e(r0, r8)
        L_0x005c:
            return r9
        */
    ...
    private static byte[] readByte(JSONObject jSONObject) throws JSONException {
        try {
            ...
            HMSLog.m1377e(TAG, "readByte failed : " + e.getMessage());
            return null;
        }
    }
            ...
            try {
                ...
                if (i != 1) {
                    if (i != 0) {
                        ...
                        HMSLog.m1377e(TAG, "cannot support type : " + i);
                    }
                }
                return readList(field.getGenericType(), (JSONObject) objectValue);
            } catch (InstantiationException unused) {
                HMSLog.m1377e(TAG, "InstantiationException  ");
            }
        }
        return null;
    }
    ...
    private static void writeByte(String str, byte[] bArr, JSONObject jSONObject) throws JSONException {
        ...
        try {
            ...
            HMSLog.m1377e(TAG, "writeByte failed : " + e.getMessage());
        }
