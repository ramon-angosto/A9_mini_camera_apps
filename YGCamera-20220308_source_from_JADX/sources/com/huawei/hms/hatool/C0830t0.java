...
public class C0830t0 {
    ...
    public static String m1029a(String str) {
        ...
        try {
            ...
            C0841y.m1084b("hmsSdk", "url don't starts with https");
            return null;
        } catch (URISyntaxException e) {
            C0841y.m1084b("hmsSdk", "getHostByURI error : " + e.getMessage());
            return null;
        }
    }

    /* renamed from: a */
    public static String m1030a(String str, int i) {
    ...
    /* renamed from: a */
    public static boolean m1031a(String str, String str2, int i) {
        String str3;
        StringBuilder sb;
        String message;
        String a = m1029a(str);
        if (TextUtils.isEmpty(a) || TextUtils.isEmpty(str2)) {
            ...
            String a2 = m1030a(a, i);
            if (TextUtils.isEmpty(a2)) {
                str3 = "get urlLastNStr is null";
            } else if (str2.equals(SHA.sha256Encrypt(a))) {
                return true;
            } else {
    ...
    /* renamed from: b */
    public static boolean m1032b(String str) {
        if (C0803i1.f646a.booleanValue()) {
            return true;
        }
        for (String a : f747a) {
            if (m1031a(str, a, 2)) {
