...
public class CustomAudioRecorder {
    ...
    public void StartRecord() {
        synchronized (this) {
            Log.d(RemoteMessageConst.Notification.TAG, "startRecord");
            if (this.bRecordThreadRuning) {
                Log.d(RemoteMessageConst.Notification.TAG, "is startRecord");
                return;
            }
            Log.d(RemoteMessageConst.Notification.TAG, "begin startRecord");
    ...
    public void StopRecord() {
        ...
        L_0x0018:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.shix.shixipc.utils.CustomAudioRecorder.StopRecord():void");
    }

    public void releaseRecord() {
        Log.d(RemoteMessageConst.Notification.TAG, "releaseRecord");
    ...
    class RecordThread implements Runnable {
        ...
        public void run() {
            ...
            while (CustomAudioRecorder.this.bRecordThreadRuning) {
                ...
                if (read != 0) {
                    Log.d(RemoteMessageConst.Notification.TAG, "read audio");
