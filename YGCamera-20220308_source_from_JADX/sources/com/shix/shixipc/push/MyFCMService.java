...
public class MyFCMService extends FirebaseMessagingService {
    ...
    private void sendNotification(String str, String str2) {
        ...
        ((NotificationManager) getSystemService(RemoteMessageConst.NOTIFICATION)).notify(0, new NotificationCompat.Builder(this).setSmallIcon(R.mipmap.qh_dev2).setContentTitle(str).setContentText(str2).setAutoCancel(true).setSound(RingtoneManager.getDefaultUri(2)).setContentIntent(PendingIntent.getActivity(this, 0, intent, 1073741824)).build());
    }

    public void InitSound() {
        if (this.f1571sp == null) {
            this.f1571sp = new SoundPool(5, 3, 0);
        }
    }

    public void playSound(int i) {
        this.f1571sp.load(this, i, 1);
        this.f1571sp.setOnLoadCompleteListener(new SoundPool.OnLoadCompleteListener() {
    ...
    private void notifyMessage(String str, String str2) {
        ...
        ((NotificationManager) CrashApplication.getContext().getSystemService(RemoteMessageConst.NOTIFICATION)).notify(this.status_code, builder.getNotification());
        this.status_code++;
    }
}
