...
public class DateModel {
    ...
    public static DateModel jsonToModel(String str) throws JSONException {
        ...
        dateModel.setTime(CommonUtil.jasonPaseInt(jSONObject, CrashHianalyticsData.TIME, ContentCommon.SHIXFINAL_ERRORINT));
    ...
    public static String toJson(DateModel dateModel, String str, String str2) throws JSONException {
        ...
        jSONObject.put(CrashHianalyticsData.TIME, dateModel.getTime());
