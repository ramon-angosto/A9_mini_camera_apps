...
public class NDNCameraLiveActivity extends BaseActivity implements View.OnClickListener, View.OnTouchListener, NUIMainActivity.PlayInterface, NUIMainActivity.SHIXCOMMONInterface, CustomAudioRecorder.AudioRecordResult {
        ...
        public void handleMessage(Message message) {
            ...
            if (i == 1) {
                if (NDNCameraLiveActivity.this.isOneShow) {
                    NDNCameraLiveActivity.this.videoView.setVisibility(8);
                ...
                NDNCameraLiveActivity.this.myRender.writeSample(NDNCameraLiveActivity.this.videodata, NDNCameraLiveActivity.this.nVideoWidth, NDNCameraLiveActivity.this.nVideoHeight);
            } else if (i == 2) {
                if (NDNCameraLiveActivity.this.isOneShow) {
                    boolean unused3 = NDNCameraLiveActivity.this.isDateComeOn = true;
                    boolean unused4 = NDNCameraLiveActivity.this.isOneShow = false;
                    boolean unused5 = NDNCameraLiveActivity.this.isDateComeOn = true;
                    NDNCameraLiveActivity.this.findViewById(R.id.progressBar).setVisibility(8);
                    NDNCameraLiveActivity.this.glVideo.setVisibility(8);
                    boolean unused6 = NDNCameraLiveActivity.this.isOneShow = false;
                }
                NDNCameraLiveActivity nDNCameraLiveActivity = NDNCameraLiveActivity.this;
                Bitmap unused7 = nDNCameraLiveActivity.mBmp = BitmapFactory.decodeByteArray(nDNCameraLiveActivity.videodata, 0, NDNCameraLiveActivity.this.videoDataLen);
                if (NDNCameraLiveActivity.this.mBmp == null) {
                    boolean unused8 = NDNCameraLiveActivity.this.bDisplayFinished = true;
                    return;
                }
                NDNCameraLiveActivity.this.getWindowManager().getDefaultDisplay().getWidth();
                NDNCameraLiveActivity.this.getWindowManager().getDefaultDisplay().getHeight();
                NDNCameraLiveActivity nDNCameraLiveActivity2 = NDNCameraLiveActivity.this;
                int unused9 = nDNCameraLiveActivity2.nVideoWidth = nDNCameraLiveActivity2.mBmp.getWidth();
                NDNCameraLiveActivity nDNCameraLiveActivity3 = NDNCameraLiveActivity.this;
                int unused10 = nDNCameraLiveActivity3.nVideoHeight = nDNCameraLiveActivity3.mBmp.getHeight();
                CommonUtil.Log(1, "nVideoWidth:" + NDNCameraLiveActivity.this.nVideoWidth + "  nVideoHeight:" + NDNCameraLiveActivity.this.nVideoHeight);
                NDNCameraLiveActivity.this.videoView.setImageBitmap(NDNCameraLiveActivity.this.mBmp);
                if (NDNCameraLiveActivity.this.isTakepic) {
                    boolean unused11 = NDNCameraLiveActivity.this.isTakepic = false;
                    NDNCameraLiveActivity nDNCameraLiveActivity4 = NDNCameraLiveActivity.this;
                    nDNCameraLiveActivity4.takePicture(nDNCameraLiveActivity4.mBmp);
                }
            } else if (i != 23) {
                if (i == 1234) {
                    if (NDNCameraLiveActivity.this.devDecoderCount2 < 10) {
                        NDNCameraLiveActivity nDNCameraLiveActivity5 = NDNCameraLiveActivity.this;
                        int unused12 = nDNCameraLiveActivity5.devDecoderCount2 = nDNCameraLiveActivity5.devDecoderCount2 + 5;
                    }
                    String string = NDNCameraLiveActivity.this.getResources().getString(R.string.n_play_hh);
                    if (NDNCameraLiveActivity.this.clickRs == 0) {
                        string = NDNCameraLiveActivity.this.getResources().getString(R.string.n_play_hh);
                    } else if (NDNCameraLiveActivity.this.clickRs == 1) {
                        string = NDNCameraLiveActivity.this.getResources().getString(R.string.n_play_h);
                    } else if (NDNCameraLiveActivity.this.clickRs == 2) {
                        string = NDNCameraLiveActivity.this.getResources().getString(R.string.n_play_l);
                    }
                    NDNCameraLiveActivity.this.tv_info.setText(NDNCameraLiveActivity.this.getResources().getString(R.string.play_res_title) + string);
                } else if (i == 123321) {
                ...
                CommonUtil.Log(1, "getQccid:" + NDNCameraLiveActivity.this.cameraParmsModel.getQccid());
                if (NDNCameraLiveActivity.this.cameraParmsModel.getQccid() != null && NDNCameraLiveActivity.this.cameraParmsModel.getQccid().length() > 5) {
                    CommonUtil.Log(1, "getQccid:" + NDNCameraLiveActivity.this.cameraParmsModel.getQccid());
                    SharedPreferences.Editor edit = NDNCameraLiveActivity.this.preuser.edit();
                    edit.putString("iccid" + NDNCameraLiveActivity.this.strDID, NDNCameraLiveActivity.this.cameraParmsModel.getQccid());
                    edit.commit();
                }
                ...
                ImageView access$4600 = NDNCameraLiveActivity.this.ivBattery;
                NDNCameraLiveActivity nDNCameraLiveActivity7 = NDNCameraLiveActivity.this;
                access$4600.setImageResource(nDNCameraLiveActivity7.getBatteryRes(nDNCameraLiveActivity7.batcapacity));
                if (NDNCameraLiveActivity.this.cameraParmsModel.getSignal() != -110) {
                    if (NDNCameraLiveActivity.this.cameraParmsModel.getSignal() >= 70) {
                        NDNCameraLiveActivity.this.ivSingn.setImageResource(R.mipmap.hz_wifisign_100);
                    } else if (NDNCameraLiveActivity.this.cameraParmsModel.getSignal() >= 40) {
                        NDNCameraLiveActivity.this.ivSingn.setImageResource(R.mipmap.hz_wifisign_50);
                    } else {
                        NDNCameraLiveActivity.this.ivSingn.setImageResource(R.mipmap.hz_wifisign_20);
                    }
                }
                if (NDNCameraLiveActivity.this.cameraParmsModel.getBatstatus() == 1) {
                    NDNCameraLiveActivity.this.ivBatterying.setVisibility(8);
                } else {
                ...
                NDNCameraLiveActivity.this.seekBar11.setProgress(NDNCameraLiveActivity.this.cameraParmsModel.getBright());
                NDNCameraLiveActivity.this.seekBar12.setProgress(NDNCameraLiveActivity.this.cameraParmsModel.getContrast());
                NDNCameraLiveActivity.this.tvSee11.setText(String.valueOf(NDNCameraLiveActivity.this.cameraParmsModel.getBright()));
                NDNCameraLiveActivity.this.tvSee12.setText(String.valueOf(NDNCameraLiveActivity.this.cameraParmsModel.getContrast()));
            }
            if (message.what == 1 || message.what == 2) {
                boolean unused22 = NDNCameraLiveActivity.this.bDisplayFinished = true;
                if (NDNCameraLiveActivity.this.isH264Data == 0) {
                    Date date = new Date(System.currentTimeMillis());
                    NDNCameraLiveActivity.this.tv_name1.setText(NDNCameraLiveActivity.this.strName + "   " + NDNCameraLiveActivity.this.simpleDateFormat.format(date));
                }
            }
        }
    };
    ...
    public Handler refreshUIHandler = new Handler() {
        ...
        public void handleMessage(Message message) {
            if (message.what == 4) {
                NDNCameraLiveActivity.access$408(NDNCameraLiveActivity.this);
    ...
    static /* synthetic */ int access$408(NDNCameraLiveActivity nDNCameraLiveActivity) {
    ...
    class CheckThread extends Thread {
        ...
        public void run() {
            super.run();
            while (NDNCameraLiveActivity.this.isCheckVideo && NDNCameraLiveActivity.this.isCheckVideo) {
                try {
                    Thread.sleep(1000);
                ...
                NDNCameraLiveActivity nDNCameraLiveActivity = NDNCameraLiveActivity.this;
                int unused = nDNCameraLiveActivity.devDecoderCount2 = nDNCameraLiveActivity.devDecoderCount1;
                int unused2 = NDNCameraLiveActivity.this.devDecoderCount1 = 0;
                if (NDNCameraLiveActivity.this.isCheckVideo) {
                    NDNCameraLiveActivity.this.mHandler.sendEmptyMessage(1234);
                } else {
                    return;
                }
            }
    ...
    private void initView() {
        ...
        this.btnPtz_up.setOnLongClickListener(new View.OnLongClickListener() {
            public boolean onLongClick(View view) {
                boolean unused = NDNCameraLiveActivity.this.isSendPtzCotr = true;
            ...
            public boolean onTouch(View view, MotionEvent motionEvent) {
                ...
                if (action == 0) {
                    ...
                    if (ContentCommon.ISVISI.booleanValue()) {
                        CommonUtil.Vibrate(NDNCameraLiveActivity.this, 10);
                    }
                    return false;
                } else if (action != 1) {
                    return true;
                    ...
                    if (NDNCameraLiveActivity.this.isSendPtzCotr) {
                        boolean unused = NDNCameraLiveActivity.this.isSendPtzCotr = false;
    ...
    public void initExitPopupWindow_more_funtion() {
        ...
        this.editTextSend = (EditText) this.popv_more_funtion.findViewById(R.id.editTextSend);
        ...
        this.btn_send = (Button) this.popv_more_funtion.findViewById(R.id.btn_send);
        this.btn_send.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                String obj = NDNCameraLiveActivity.this.editTextSend.getText().toString();
                if (obj == null || obj.length() < 1) {
                    NDNCameraLiveActivity.this.showToast("请输入要透传发送的内容");
                } else {
                    NativeCaller.TransferMessage(NDNCameraLiveActivity.this.strDID, CommonUtil.sendTrans(SystemValue.doorBellAdmin, SystemValue.doorBellPass, obj), 0);
                }
            }
        });
        this.sv_szp.setOnStateChangedListener(new SwitchView.OnStateChangedListener() {
            public void toggleToOn(SwitchView switchView) {
                NDNCameraLiveActivity.this.sv_szp.setOpened(true);
                NativeCaller.TransferMessage(NDNCameraLiveActivity.this.strDID, CommonUtil.CameraControl(SystemValue.doorBellAdmin, SystemValue.doorBellPass, "clockScreen", 1), 0);
                NDNCameraLiveActivity.this.cameraParmsModel.setClockScreen(1);
            }

            public void toggleToOff(SwitchView switchView) {
                NDNCameraLiveActivity.this.sv_szp.setOpened(false);
                NativeCaller.TransferMessage(NDNCameraLiveActivity.this.strDID, CommonUtil.CameraControl(SystemValue.doorBellAdmin, SystemValue.doorBellPass, "clockScreen", 0), 0);
                NDNCameraLiveActivity.this.cameraParmsModel.setClockScreen(0);
            }
        });
        this.sv_zsd.setOnStateChangedListener(new SwitchView.OnStateChangedListener() {
            public void toggleToOn(SwitchView switchView) {
                NDNCameraLiveActivity.this.sv_zsd.setOpened(true);
                NativeCaller.TransferMessage(NDNCameraLiveActivity.this.strDID, CommonUtil.CameraControl(SystemValue.doorBellAdmin, SystemValue.doorBellPass, "lamp", 1), 0);
                NDNCameraLiveActivity.this.cameraParmsModel.setLamp(1);
            }

            public void toggleToOff(SwitchView switchView) {
                NDNCameraLiveActivity.this.sv_zsd.setOpened(false);
                NativeCaller.TransferMessage(NDNCameraLiveActivity.this.strDID, CommonUtil.CameraControl(SystemValue.doorBellAdmin, SystemValue.doorBellPass, "lamp", 0), 0);
                NDNCameraLiveActivity.this.cameraParmsModel.setLamp(0);
            }
        });
        ...
        this.popv_more_funtion.findViewById(R.id.buttonSD).setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                NDNCameraLiveActivity.this.popupWindow_more_funtion.dismiss();
                Intent intent = new Intent(NDNCameraLiveActivity.this, PlayBackActivity.class);
    ...
    public synchronized void savePicToSDcard(android.graphics.Bitmap r8) {
        ...
        L_0x0024:
            ...
            com.shix.shixipc.activity.NDNCameraLiveActivity$31 r0 = new com.shix.shixipc.activity.NDNCameraLiveActivity$31     // Catch:{ Exception -> 0x0051, all -> 0x004e }
        ...
        L_0x0058:
            r1 = move-exception
        L_0x0059:
            com.shix.shixipc.activity.NDNCameraLiveActivity$32 r3 = new com.shix.shixipc.activity.NDNCameraLiveActivity$32     // Catch:{ all -> 0x0056 }
    ...
    public void CallBackSHIXJasonCommon(String str, String str2) {
        if (str2.indexOf("101") > 0) {
            try {
                ...
                CommonUtil.Log(1, "setQccid0:");
                String jasonPaseString = CommonUtil.jasonPaseString(jSONObject, "qccid");
                CommonUtil.Log(1, "setQccid1:" + jasonPaseString);
                if (jasonPaseString != null) {
                    CommonUtil.Log(1, "setQccid2:" + jasonPaseString);
                    SharedPreferences.Editor edit = this.preuser.edit();
                    edit.putString("iccid" + this.strDID, jasonPaseString);
                    edit.commit();
                } else {
                    CommonUtil.Log(1, "getQccid: == null");
                }
            } catch (Exception unused) {
                CommonUtil.Log(1, "setQccid444:");
            }
            try {
