...
public class ApConnectActivity extends BaseActivity implements View.OnClickListener, NUIMainActivity.AddCameraInterface1 {
    ...
    public Handler MsgHandler = new Handler() {
        public void handleMessage(Message message) {
            if (message.what == 1) {
                if (ApConnectActivity.this.nowssid != null && ApConnectActivity.this.nowssid.length() > 0 && ApConnectActivity.this.nowssid.startsWith(ContentCommon.SHIX_APPRE)) {
    ...
    public void callBackSearchResultData(int i, String str, String str2, String str3, String str4, int i2) {
        ...
        if (str5 == null || str5.length() < 5) {
            this.strUid = str3.replace(Constants.ACCEPT_TIME_SEPARATOR_SERVER, "").trim();
