...
public class SettingSDCardActivity extends BaseActivity implements View.OnClickListener, CompoundButton.OnCheckedChangeListener, NUIMainActivity.SHIXCOMMONInterface {
            ...
            if (i == 0) {
                ...
                if (SettingSDCardActivity.this.sdModel != null) {
                    if (SettingSDCardActivity.this.sdModel.getTotal() == 0) {
                        ...
                        TextView access$300 = SettingSDCardActivity.this.tvSdRemain;
                ...
                if (SettingSDCardActivity.this.videoRecordModel != null) {
                    ...
                    EditText access$1300 = SettingSDCardActivity.this.editRecordLength;
                    access$1300.setText((SettingSDCardActivity.this.videoRecordModel.getRecord_time() / 60) + "");
                }
            }
        }
    };
    ...
    public void initExitPopupWindow_videomode() {
        ...
        this.popv_videomode.findViewById(R.id.btn_videomode1).setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                ...
                SettingSDCardActivity.this.videoRecordModel.setEnd_time(RemoteMessageConst.DEFAULT_TTL);
            }
        });
            ...
            public void onClick(View view) {
                ...
                new TimePickerDialog(SettingSDCardActivity.this, 2, new TimePickerDialog.OnTimeSetListener() {
                    public void onTimeSet(TimePicker timePicker, int i, int i2) {
                        ...
                        int access$500 = (SettingSDCardActivity.this.m_start_time_hour * 3600) + (SettingSDCardActivity.this.m_start_time_min * 60);
                        if (SettingSDCardActivity.this.videoRecordModel != null) {
                            SettingSDCardActivity.this.videoRecordModel.setStart_time(access$500);
                        }
                        TextView textView = SettingSDCardActivity.this.tv_starttime;
            ...
            public void onClick(View view) {
                ...
                new TimePickerDialog(SettingSDCardActivity.this, 2, new TimePickerDialog.OnTimeSetListener() {
                    public void onTimeSet(TimePicker timePicker, int i, int i2) {
                        ...
                        int access$700 = (SettingSDCardActivity.this.m_end_time_hour * 3600) + (SettingSDCardActivity.this.m_end_time_min * 60);
                        if (SettingSDCardActivity.this.videoRecordModel != null) {
                            SettingSDCardActivity.this.videoRecordModel.setEnd_time(access$700);
                        }
                ...
                public void onClick(View view) {
                    new AsyncTask<Void, Void, Void>() {
                        ...
                        public void onPostExecute(Void voidR) {
                            ...
                            NativeCaller.TransferMessage(SettingSDCardActivity.this.strDID, CommonUtil.setSDVideoMode(SystemValue.doorBellAdmin, SystemValue.doorBellPass, 1), 0);
    ...
    public void onCheckedChanged(CompoundButton compoundButton, boolean z) {
        switch (compoundButton.getId()) {
            case R.id.cbx_coverage /*2131165337*/:
                if (z) {
