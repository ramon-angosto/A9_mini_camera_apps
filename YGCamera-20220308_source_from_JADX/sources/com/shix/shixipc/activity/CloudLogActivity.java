...
public class CloudLogActivity extends BaseActivity implements View.OnClickListener {
    ...
    private Handler BitMapHandler = new Handler() {
        public void handleMessage(Message message) {
            ...
            CloudLogActivity.this.textView_name.setText("/mnt/sdcard/YGCamera/picVisitor/");
        ...
        public void handleMessage(Message message) {
            ...
            if (i == 1) {
                ...
                if (substring.length() >= 21) {
                    ...
                    cloudBean.setCreateTime(substring.substring(0, 10) + "  " + substring.substring(11, 19).replace(Constants.ACCEPT_TIME_SEPARATOR_SERVER, Constants.COLON_SEPARATOR));
    ...
    /* JADX WARNING: Removed duplicated region for block: B:24:0x00e0 A[ExcHandler: ServiceException (r6v7 'e' com.alibaba.sdk.android.oss.ServiceException A[CUSTOM_DECLARE]), Splitter:B:9:0x0059] */
    /* JADX WARNING: Removed duplicated region for block: B:26:0x0106 A[ExcHandler: ClientException (r6v6 'e' com.alibaba.sdk.android.oss.ClientException A[CUSTOM_DECLARE]), Splitter:B:9:0x0059] */
    ...
    public void getObjectSample(java.lang.String r6, java.lang.String r7, java.lang.String r8) {
        /*
            ...
            java.lang.String r2 = "YGCamera/cloud"
            r0.<init>(r1, r2)
        ...
        L_0x004d:
            ...
            r6.<init>(r0, r8)
            com.alibaba.sdk.android.oss.OSS r8 = r5.oss     // Catch:{ ClientException -> 0x0106, ServiceException -> 0x00e0, IOException -> 0x00db }
            com.alibaba.sdk.android.oss.model.GetObjectResult r6 = r8.getObject(r6)     // Catch:{ ClientException -> 0x0106, ServiceException -> 0x00e0, IOException -> 0x00db }
            java.lang.String r8 = "Content-Length"
            java.lang.StringBuilder r0 = new java.lang.StringBuilder     // Catch:{ ClientException -> 0x0106, ServiceException -> 0x00e0, IOException -> 0x00db }
            r0.<init>()     // Catch:{ ClientException -> 0x0106, ServiceException -> 0x00e0, IOException -> 0x00db }
            java.lang.String r1 = ""
            r0.append(r1)     // Catch:{ ClientException -> 0x0106, ServiceException -> 0x00e0, IOException -> 0x00db }
            long r1 = r6.getContentLength()     // Catch:{ ClientException -> 0x0106, ServiceException -> 0x00e0, IOException -> 0x00db }
            r0.append(r1)     // Catch:{ ClientException -> 0x0106, ServiceException -> 0x00e0, IOException -> 0x00db }
            java.lang.String r0 = r0.toString()     // Catch:{ ClientException -> 0x0106, ServiceException -> 0x00e0, IOException -> 0x00db }
            android.util.Log.d(r8, r0)     // Catch:{ ClientException -> 0x0106, ServiceException -> 0x00e0, IOException -> 0x00db }
            java.io.InputStream r8 = r6.getObjectContent()     // Catch:{ ClientException -> 0x0106, ServiceException -> 0x00e0, IOException -> 0x00db }
            r0 = 2048(0x800, float:2.87E-42)
            byte[] r0 = new byte[r0]     // Catch:{ ClientException -> 0x0106, ServiceException -> 0x00e0, IOException -> 0x00db }
        L_0x0081:
            int r1 = r8.read(r0)     // Catch:{ ClientException -> 0x0106, ServiceException -> 0x00e0, IOException -> 0x00db }
            r2 = -1
            java.lang.String r3 = "asyncGetObjectSample"
            if (r1 == r2) goto L_0x00b9
            java.lang.StringBuilder r2 = new java.lang.StringBuilder     // Catch:{ ClientException -> 0x0106, ServiceException -> 0x00e0, IOException -> 0x00db }
            r2.<init>()     // Catch:{ ClientException -> 0x0106, ServiceException -> 0x00e0, IOException -> 0x00db }
            java.lang.String r4 = "read length: "
            r2.append(r4)     // Catch:{ ClientException -> 0x0106, ServiceException -> 0x00e0, IOException -> 0x00db }
            r2.append(r1)     // Catch:{ ClientException -> 0x0106, ServiceException -> 0x00e0, IOException -> 0x00db }
            java.lang.String r2 = r2.toString()     // Catch:{ ClientException -> 0x0106, ServiceException -> 0x00e0, IOException -> 0x00db }
            android.util.Log.d(r3, r2)     // Catch:{ ClientException -> 0x0106, ServiceException -> 0x00e0, IOException -> 0x00db }
            java.lang.StringBuilder r2 = new java.lang.StringBuilder     // Catch:{ ClientException -> 0x0106, ServiceException -> 0x00e0, IOException -> 0x00db }
            r2.<init>()     // Catch:{ ClientException -> 0x0106, ServiceException -> 0x00e0, IOException -> 0x00db }
            java.lang.String r3 = "len:"
            r2.append(r3)     // Catch:{ ClientException -> 0x0106, ServiceException -> 0x00e0, IOException -> 0x00db }
            r2.append(r1)     // Catch:{ ClientException -> 0x0106, ServiceException -> 0x00e0, IOException -> 0x00db }
            java.lang.String r2 = r2.toString()     // Catch:{ ClientException -> 0x0106, ServiceException -> 0x00e0, IOException -> 0x00db }
            com.shix.shixipc.utils.CommonUtil.Log(r7, r2)     // Catch:{ ClientException -> 0x0106, ServiceException -> 0x00e0, IOException -> 0x00db }
            java.io.FileOutputStream r2 = r5.testOS     // Catch:{ ClientException -> 0x0106, ServiceException -> 0x00e0, IOException -> 0x00db }
            r3 = 0
            r2.write(r0, r3, r1)     // Catch:{ ClientException -> 0x0106, ServiceException -> 0x00e0, IOException -> 0x00db }
            goto L_0x0081
        L_0x00b9:
            java.lang.String r7 = "download success."
            android.util.Log.d(r3, r7)     // Catch:{ ClientException -> 0x0106, ServiceException -> 0x00e0, IOException -> 0x00db }
            com.alibaba.sdk.android.oss.model.ObjectMetadata r6 = r6.getMetadata()     // Catch:{ ClientException -> 0x0106, ServiceException -> 0x00e0, IOException -> 0x00db }
            java.lang.String r7 = "ContentType"
            java.lang.String r6 = r6.getContentType()     // Catch:{ ClientException -> 0x0106, ServiceException -> 0x00e0, IOException -> 0x00db }
            android.util.Log.d(r7, r6)     // Catch:{ ClientException -> 0x0106, ServiceException -> 0x00e0, IOException -> 0x00db }
            java.io.FileOutputStream r6 = r5.testOS     // Catch:{ IOException -> 0x00d6, ClientException -> 0x0106, ServiceException -> 0x00e0 }
            r6.flush()     // Catch:{ IOException -> 0x00d6, ClientException -> 0x0106, ServiceException -> 0x00e0 }
            java.io.FileOutputStream r6 = r5.testOS     // Catch:{ IOException -> 0x00d6, ClientException -> 0x0106, ServiceException -> 0x00e0 }
            r6.close()     // Catch:{ IOException -> 0x00d6, ClientException -> 0x0106, ServiceException -> 0x00e0 }
            goto L_0x010a
        L_0x00d6:
            r6 = move-exception
            r6.printStackTrace()     // Catch:{ ClientException -> 0x0106, ServiceException -> 0x00e0, IOException -> 0x00db }
            goto L_0x010a
        L_0x00db:
            r6 = move-exception
            r6.printStackTrace()
    ...
    public synchronized void savePicToSDcard() {
        /*
            ...
            java.lang.String r4 = "YGCamera/picVisitor"
    ...
    private synchronized android.net.Uri savePicToSDcard(android.graphics.Bitmap r7) {
        /*
            ...
            java.io.File r3 = android.os.Environment.getExternalStorageDirectory()     // Catch:{ Exception -> 0x00c7 }
    ...
    public void onDestroy() {
        super.onDestroy();
        this.adapter = null;
        ((NotificationManager) getSystemService(RemoteMessageConst.NOTIFICATION)).cancel(110);
    }
    ...
    class MyAsyncTask extends AsyncTask<String, Integer, String> {
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:32:0x0169, code lost:
            r12 = move-exception;
         */
        /* JADX WARNING: Code restructure failed: missing block: B:33:0x016a, code lost:
         ...
         */
        /* JADX WARNING: Failed to process nested try/catch */
        /* JADX WARNING: Removed duplicated region for block: B:32:0x0169 A[ExcHandler: ServiceException (r12v3 'e' com.alibaba.sdk.android.oss.ServiceException A[CUSTOM_DECLARE]), Splitter:B:16:0x008e] */
        /* JADX WARNING: Removed duplicated region for block: B:35:0x018f A[ExcHandler: ClientException (r12v2 'e' com.alibaba.sdk.android.oss.ClientException A[CUSTOM_DECLARE]), Splitter:B:16:0x008e] */
        /* Code decompiled incorrectly, please refer to instructions dump. */
        public java.lang.String doInBackground(java.lang.String... r12) {
            /*
                ...
                java.lang.String r3 = "YGCamera/cloud"
                r1.<init>(r2, r3)
            ...
            L_0x0082:
                ...
                r2.<init>(r4, r12)
                com.shix.shixipc.activity.CloudLogActivity r12 = com.shix.shixipc.activity.CloudLogActivity.this     // Catch:{ ClientException -> 0x018f, ServiceException -> 0x0169, IOException -> 0x0164 }
                com.alibaba.sdk.android.oss.OSS r12 = r12.oss     // Catch:{ ClientException -> 0x018f, ServiceException -> 0x0169, IOException -> 0x0164 }
                com.alibaba.sdk.android.oss.model.GetObjectResult r12 = r12.getObject(r2)     // Catch:{ ClientException -> 0x018f, ServiceException -> 0x0169, IOException -> 0x0164 }
                long r4 = r12.getContentLength()     // Catch:{ ClientException -> 0x018f, ServiceException -> 0x0169, IOException -> 0x0164 }
                r11.allLen = r4     // Catch:{ ClientException -> 0x018f, ServiceException -> 0x0169, IOException -> 0x0164 }
                java.lang.String r2 = "Content-Length"
                java.lang.StringBuilder r4 = new java.lang.StringBuilder     // Catch:{ ClientException -> 0x018f, ServiceException -> 0x0169, IOException -> 0x0164 }
                r4.<init>()     // Catch:{ ClientException -> 0x018f, ServiceException -> 0x0169, IOException -> 0x0164 }
                java.lang.String r5 = "allLen:"
                r4.append(r5)     // Catch:{ ClientException -> 0x018f, ServiceException -> 0x0169, IOException -> 0x0164 }
                long r7 = r11.allLen     // Catch:{ ClientException -> 0x018f, ServiceException -> 0x0169, IOException -> 0x0164 }
                r4.append(r7)     // Catch:{ ClientException -> 0x018f, ServiceException -> 0x0169, IOException -> 0x0164 }
                java.lang.String r4 = r4.toString()     // Catch:{ ClientException -> 0x018f, ServiceException -> 0x0169, IOException -> 0x0164 }
                android.util.Log.d(r2, r4)     // Catch:{ ClientException -> 0x018f, ServiceException -> 0x0169, IOException -> 0x0164 }
                java.io.InputStream r2 = r12.getObjectContent()     // Catch:{ ClientException -> 0x018f, ServiceException -> 0x0169, IOException -> 0x0164 }
                r4 = 2048(0x800, float:2.87E-42)
                byte[] r4 = new byte[r4]     // Catch:{ ClientException -> 0x018f, ServiceException -> 0x0169, IOException -> 0x0164 }
            L_0x00be:
                int r5 = r2.read(r4)     // Catch:{ ClientException -> 0x018f, ServiceException -> 0x0169, IOException -> 0x0164 }
                r7 = -1
                java.lang.String r8 = "asyncGetObjectSample"
                if (r5 == r7) goto L_0x013e
                java.lang.StringBuilder r7 = new java.lang.StringBuilder     // Catch:{ ClientException -> 0x018f, ServiceException -> 0x0169, IOException -> 0x0164 }
                r7.<init>()     // Catch:{ ClientException -> 0x018f, ServiceException -> 0x0169, IOException -> 0x0164 }
                java.lang.String r9 = "read length: "
                r7.append(r9)     // Catch:{ ClientException -> 0x018f, ServiceException -> 0x0169, IOException -> 0x0164 }
                r7.append(r5)     // Catch:{ ClientException -> 0x018f, ServiceException -> 0x0169, IOException -> 0x0164 }
                java.lang.String r7 = r7.toString()     // Catch:{ ClientException -> 0x018f, ServiceException -> 0x0169, IOException -> 0x0164 }
                android.util.Log.d(r8, r7)     // Catch:{ ClientException -> 0x018f, ServiceException -> 0x0169, IOException -> 0x0164 }
                java.lang.StringBuilder r7 = new java.lang.StringBuilder     // Catch:{ ClientException -> 0x018f, ServiceException -> 0x0169, IOException -> 0x0164 }
                r7.<init>()     // Catch:{ ClientException -> 0x018f, ServiceException -> 0x0169, IOException -> 0x0164 }
                java.lang.String r8 = "len:"
                r7.append(r8)     // Catch:{ ClientException -> 0x018f, ServiceException -> 0x0169, IOException -> 0x0164 }
                r7.append(r5)     // Catch:{ ClientException -> 0x018f, ServiceException -> 0x0169, IOException -> 0x0164 }
                java.lang.String r7 = r7.toString()     // Catch:{ ClientException -> 0x018f, ServiceException -> 0x0169, IOException -> 0x0164 }
                com.shix.shixipc.utils.CommonUtil.Log(r3, r7)     // Catch:{ ClientException -> 0x018f, ServiceException -> 0x0169, IOException -> 0x0164 }
                com.shix.shixipc.activity.CloudLogActivity r7 = com.shix.shixipc.activity.CloudLogActivity.this     // Catch:{ ClientException -> 0x018f, ServiceException -> 0x0169, IOException -> 0x0164 }
                java.io.FileOutputStream r7 = r7.testOS     // Catch:{ ClientException -> 0x018f, ServiceException -> 0x0169, IOException -> 0x0164 }
                r7.write(r4, r0, r5)     // Catch:{ ClientException -> 0x018f, ServiceException -> 0x0169, IOException -> 0x0164 }
                long r7 = r11.downLen     // Catch:{ ClientException -> 0x018f, ServiceException -> 0x0169, IOException -> 0x0164 }
                long r9 = (long) r5     // Catch:{ ClientException -> 0x018f, ServiceException -> 0x0169, IOException -> 0x0164 }
                long r7 = r7 + r9
                r11.downLen = r7     // Catch:{ ClientException -> 0x018f, ServiceException -> 0x0169, IOException -> 0x0164 }
                long r7 = r11.downLen     // Catch:{ ClientException -> 0x018f, ServiceException -> 0x0169, IOException -> 0x0164 }
                float r5 = (float) r7     // Catch:{ ClientException -> 0x018f, ServiceException -> 0x0169, IOException -> 0x0164 }
                long r7 = r11.allLen     // Catch:{ ClientException -> 0x018f, ServiceException -> 0x0169, IOException -> 0x0164 }
                float r7 = (float) r7     // Catch:{ ClientException -> 0x018f, ServiceException -> 0x0169, IOException -> 0x0164 }
                float r5 = r5 / r7
                java.lang.String r7 = "test"
                java.lang.StringBuilder r8 = new java.lang.StringBuilder     // Catch:{ ClientException -> 0x018f, ServiceException -> 0x0169, IOException -> 0x0164 }
                r8.<init>()     // Catch:{ ClientException -> 0x018f, ServiceException -> 0x0169, IOException -> 0x0164 }
                java.lang.String r9 = "process:"
                r8.append(r9)     // Catch:{ ClientException -> 0x018f, ServiceException -> 0x0169, IOException -> 0x0164 }
                r8.append(r5)     // Catch:{ ClientException -> 0x018f, ServiceException -> 0x0169, IOException -> 0x0164 }
                java.lang.String r9 = " downLen:"
                r8.append(r9)     // Catch:{ ClientException -> 0x018f, ServiceException -> 0x0169, IOException -> 0x0164 }
                long r9 = r11.downLen     // Catch:{ ClientException -> 0x018f, ServiceException -> 0x0169, IOException -> 0x0164 }
                r8.append(r9)     // Catch:{ ClientException -> 0x018f, ServiceException -> 0x0169, IOException -> 0x0164 }
                java.lang.String r9 = "  allLen:"
                r8.append(r9)     // Catch:{ ClientException -> 0x018f, ServiceException -> 0x0169, IOException -> 0x0164 }
                long r9 = r11.allLen     // Catch:{ ClientException -> 0x018f, ServiceException -> 0x0169, IOException -> 0x0164 }
                r8.append(r9)     // Catch:{ ClientException -> 0x018f, ServiceException -> 0x0169, IOException -> 0x0164 }
                java.lang.String r8 = r8.toString()     // Catch:{ ClientException -> 0x018f, ServiceException -> 0x0169, IOException -> 0x0164 }
                android.util.Log.d(r7, r8)     // Catch:{ ClientException -> 0x018f, ServiceException -> 0x0169, IOException -> 0x0164 }
                java.lang.Integer[] r7 = new java.lang.Integer[r3]     // Catch:{ ClientException -> 0x018f, ServiceException -> 0x0169, IOException -> 0x0164 }
                r8 = 1120403456(0x42c80000, float:100.0)
                float r5 = r5 * r8
                int r5 = (int) r5     // Catch:{ ClientException -> 0x018f, ServiceException -> 0x0169, IOException -> 0x0164 }
                java.lang.Integer r5 = java.lang.Integer.valueOf(r5)     // Catch:{ ClientException -> 0x018f, ServiceException -> 0x0169, IOException -> 0x0164 }
                r7[r0] = r5     // Catch:{ ClientException -> 0x018f, ServiceException -> 0x0169, IOException -> 0x0164 }
                r11.publishProgress(r7)     // Catch:{ ClientException -> 0x018f, ServiceException -> 0x0169, IOException -> 0x0164 }
                goto L_0x00be
            L_0x013e:
                java.lang.String r0 = "download success."
                android.util.Log.d(r8, r0)     // Catch:{ ClientException -> 0x018f, ServiceException -> 0x0169, IOException -> 0x0164 }
                com.alibaba.sdk.android.oss.model.ObjectMetadata r12 = r12.getMetadata()     // Catch:{ ClientException -> 0x018f, ServiceException -> 0x0169, IOException -> 0x0164 }
                java.lang.String r0 = "ContentType"
                java.lang.String r12 = r12.getContentType()     // Catch:{ ClientException -> 0x018f, ServiceException -> 0x0169, IOException -> 0x0164 }
                android.util.Log.d(r0, r12)     // Catch:{ ClientException -> 0x018f, ServiceException -> 0x0169, IOException -> 0x0164 }
                com.shix.shixipc.activity.CloudLogActivity r12 = com.shix.shixipc.activity.CloudLogActivity.this     // Catch:{ IOException -> 0x015f, ClientException -> 0x018f, ServiceException -> 0x0169 }
                java.io.FileOutputStream r12 = r12.testOS     // Catch:{ IOException -> 0x015f, ClientException -> 0x018f, ServiceException -> 0x0169 }
                r12.flush()     // Catch:{ IOException -> 0x015f, ClientException -> 0x018f, ServiceException -> 0x0169 }
                com.shix.shixipc.activity.CloudLogActivity r12 = com.shix.shixipc.activity.CloudLogActivity.this     // Catch:{ IOException -> 0x015f, ClientException -> 0x018f, ServiceException -> 0x0169 }
                java.io.FileOutputStream r12 = r12.testOS     // Catch:{ IOException -> 0x015f, ClientException -> 0x018f, ServiceException -> 0x0169 }
                r12.close()     // Catch:{ IOException -> 0x015f, ClientException -> 0x018f, ServiceException -> 0x0169 }
                goto L_0x0168
            L_0x015f:
                r12 = move-exception
                r12.printStackTrace()     // Catch:{ ClientException -> 0x018f, ServiceException -> 0x0169, IOException -> 0x0164 }
                goto L_0x0168
            L_0x0164:
                r12 = move-exception
                r12.printStackTrace()
