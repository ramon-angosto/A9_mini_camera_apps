...
public enum C1789ff {
    ...
    GSLB_REQUEST_SUCCESS(HwBuildEx.VersionCodes.CUR_DEVELOPMENT),
    ...
    private C1789ff(int i) {
        this.f2351a = i;
    }

    /* renamed from: a */
    public static C1789ff m3489a(int i) {
        if (i == 30501) {
            return BIND_TIMEOUT;
        }
        if (i == 30502) {
        ...
        switch (i) {
            ...
            default:
                switch (i) {
                    case JosStatusCodes.RTN_CODE_COMMON_ERROR:
                        return CHANNEL_STATS_COUNTER;
                    case HwBuildEx.VersionCodes.CUR_DEVELOPMENT:
