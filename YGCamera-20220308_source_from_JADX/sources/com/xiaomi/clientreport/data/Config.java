...
public class Config {
    ...
    private Config(Context context, Builder builder) {
        ...
        this.mAESKey = !TextUtils.isEmpty(builder.mAESKey) ? builder.mAESKey : C1667bs.m2746a(context);
    ...
    public static Config defaultConfig(Context context) {
        return getBuilder().setEventEncrypted(true).setAESKey(C1667bs.m2746a(context)).setMaxFileLength(1048576).setEventUploadSwitchOpen(false).setEventUploadFrequency(86400).setPerfUploadSwitchOpen(false).setPerfUploadFrequency(86400).build(context);
    }
