...
public class StreamBitmapDecoder implements ResourceDecoder<InputStream, Bitmap> {
    ...
    /* renamed from: ID */
    private static final String f61ID = "StreamBitmapDecoder.com.bumptech.glide.load.resource.bitmap";
    ...
    public String getId() {
        if (this.f62id == null) {
            this.f62id = f61ID + this.downsampler.getId() + this.decodeFormat.name();
        }
        return this.f62id;
    }
}
