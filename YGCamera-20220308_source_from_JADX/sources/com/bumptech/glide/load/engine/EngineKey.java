...
class EngineKey implements Key {
    ...
    public Key getOriginalKey() {
        if (this.originalKey == null) {
            this.originalKey = new OriginalKey(this.f56id, this.signature);
        }
    ...
    public boolean equals(Object obj) {
        ...
        if (!this.f56id.equals(engineKey.f56id) || !this.signature.equals(engineKey.signature) || this.height != engineKey.height || this.width != engineKey.width) {
            return false;
        }
    ...
    public int hashCode() {
        if (this.hashCode == 0) {
            this.hashCode = this.f56id.hashCode();
    ...
    public void updateDiskCacheKey(MessageDigest messageDigest) throws UnsupportedEncodingException {
        ...
        messageDigest.update(this.f56id.getBytes(Key.STRING_CHARSET_NAME));
        messageDigest.update(array);
        ResourceDecoder resourceDecoder = this.cacheDecoder;
        String str = "";
        messageDigest.update((resourceDecoder != null ? resourceDecoder.getId() : str).getBytes(Key.STRING_CHARSET_NAME));
        ResourceDecoder resourceDecoder2 = this.decoder;
        messageDigest.update((resourceDecoder2 != null ? resourceDecoder2.getId() : str).getBytes(Key.STRING_CHARSET_NAME));
        Transformation transformation2 = this.transformation;
        messageDigest.update((transformation2 != null ? transformation2.getId() : str).getBytes(Key.STRING_CHARSET_NAME));
        ResourceEncoder resourceEncoder = this.encoder;
        messageDigest.update((resourceEncoder != null ? resourceEncoder.getId() : str).getBytes(Key.STRING_CHARSET_NAME));
        Encoder encoder2 = this.sourceEncoder;
        if (encoder2 != null) {
            str = encoder2.getId();
        }
