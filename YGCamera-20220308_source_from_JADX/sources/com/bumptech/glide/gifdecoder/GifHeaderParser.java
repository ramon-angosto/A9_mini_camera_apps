...
public class GifHeaderParser {
    ...
    private void readBitmap() {
        this.header.currentFrame.f51ix = readShort();
        this.header.currentFrame.f52iy = readShort();
        this.header.currentFrame.f50iw = readShort();
        this.header.currentFrame.f49ih = readShort();
        int read = read();
        boolean z = false;
