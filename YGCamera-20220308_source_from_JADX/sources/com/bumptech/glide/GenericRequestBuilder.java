    ...
    public Target<TranscodeType> into(ImageView imageView) {
        ...
        if (imageView != null) {
            if (!this.isTransformationSet && imageView.getScaleType() != null) {
                int i = C04412.$SwitchMap$android$widget$ImageView$ScaleType[imageView.getScaleType().ordinal()];
                if (i == 1) {
                    applyCenterCrop();
                } else if (i == 2 || i == 3 || i == 4) {
                    applyFitCenter();
    ...
    static /* synthetic */ class C04412 {
        ...
        static {
            ...
            L_0x0035:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.bumptech.glide.GenericRequestBuilder.C04412.<clinit>():void");
        }
    }
