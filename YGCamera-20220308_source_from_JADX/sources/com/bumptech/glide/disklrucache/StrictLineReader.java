...
class StrictLineReader implements Closeable {
    ...
    /* renamed from: CR */
    private static final byte f46CR = 13;

    /* renamed from: LF */
    private static final byte f47LF = 10;
    private byte[] buf;
    ...
    public String readLine() throws IOException {
        ...
        synchronized (this.f48in) {
            if (this.buf != null) {
                ...
                C04471 r1 = new ByteArrayOutputStream((this.end - this.pos) + 80) {
    ...
    private void fillBuf() throws IOException {
        InputStream inputStream = this.f48in;
        byte[] bArr = this.buf;
