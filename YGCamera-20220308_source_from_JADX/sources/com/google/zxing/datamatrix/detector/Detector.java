...
public final class Detector {
    ...
    public DetectorResult detect() throws NotFoundException {
        ...
        Collections.sort(arrayList, new ResultPointsAndTransitionsComparator((ResultPointsAndTransitionsComparator) null));
    ...
    private ResultPointsAndTransitions transitionsBetween(ResultPoint resultPoint, ResultPoint resultPoint2) {
        ...
        return new ResultPointsAndTransitions(resultPoint, resultPoint2, i, (ResultPointsAndTransitions) null);
    }
    ...
    private static final class ResultPointsAndTransitions {
        ...
        /* renamed from: to */
        private final ResultPoint f70to;
        private final int transitions;

        private ResultPointsAndTransitions(ResultPoint resultPoint, ResultPoint resultPoint2, int i) {
            this.from = resultPoint;
            this.f70to = resultPoint2;
            this.transitions = i;
        }
        ...
        public String toString() {
            return this.from + "/" + this.f70to + '/' + this.transitions;
        }
    }
