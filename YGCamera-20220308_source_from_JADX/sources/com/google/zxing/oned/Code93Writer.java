...
public class Code93Writer extends OneDimensionalCodeWriter {
    ...
    public boolean[] encode(String str) {
        ...
        if (length <= 80) {
            ...
            toIntArray(Code93Reader.CHARACTER_ENCODINGS[computeChecksumIndex(String.valueOf(str) + "0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ-. $/+%abcd*".charAt(computeChecksumIndex), 15)], iArr);
