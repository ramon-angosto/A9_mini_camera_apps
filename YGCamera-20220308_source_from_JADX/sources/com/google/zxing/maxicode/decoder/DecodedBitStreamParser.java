...
final class DecodedBitStreamParser {
    ...
    /* renamed from: FS */
    private static final char f71FS = '\u001c';

    /* renamed from: GS */
    private static final char f72GS = '\u001d';
    private static final char LATCHA = '￷';
    private static final char LATCHB = '￸';
    private static final char LOCK = '￹';

    /* renamed from: NS */
    private static final char f73NS = '￻';
    private static final char PAD = '￼';

    /* renamed from: RS */
    private static final char f74RS = '\u001e';
    ...
    static DecoderResult decode(byte[] bArr, int i) {
        ...
        if (i == 2 || i == 3) {
            ...
            if (sb.toString().startsWith("[)>\u001e01\u001d")) {
                sb.insert(9, String.valueOf(str) + f72GS + format + f72GS + format2 + f72GS);
            } else {
                sb.insert(0, String.valueOf(str) + f72GS + format + f72GS + format2 + f72GS);
            }
        } else if (i == 4) {
