...
public final class GUIRunner extends JFrame {
    ...
    private GUIRunner() {
        ...
        this.textArea.setMaximumSize(new Dimension(AGCServerException.AUTHENTICATION_INVALID, 200));
        JPanel jPanel = new JPanel();
        jPanel.setLayout(new FlowLayout());
        jPanel.add(this.imageLabel);
        jPanel.add(this.textArea);
        setTitle("ZXing");
        setSize(AGCServerException.AUTHENTICATION_INVALID, AGCServerException.AUTHENTICATION_INVALID);
