...
public class FirebaseApp {
    ...
    public String toString() {
        return Objects.toStringHelper(this).add(SharedPreferencesUtils.USER_NAME, this.name).add("options", this.options).toString();
    }
    ...
    protected FirebaseApp(Context context, String str, FirebaseOptions firebaseOptions) {
        ...
        this.componentRuntime = new ComponentRuntime(UI_EXECUTOR, discover, Component.m30of(context, Context.class, new Class[0]), Component.m30of(this, FirebaseApp.class, new Class[0]), Component.m30of(firebaseOptions, FirebaseOptions.class, new Class[0]), LibraryVersionComponent.create(FIREBASE_ANDROID, ""), LibraryVersionComponent.create(FIREBASE_COMMON, BuildConfig.VERSION_NAME), DefaultUserAgentPublisher.component());
