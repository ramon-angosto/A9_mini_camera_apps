...
final class zzax {
    ...
    public final synchronized Task<Void> zza(String str) {
        ...
        if (TextUtils.isEmpty(zza2)) {
            ...
            i = zza2.split(Constants.ACCEPT_TIME_SEPARATOR_SP).length - 1;
        }
    ...
    private final String zzb() {
        ...
        String[] split = zza2.split(Constants.ACCEPT_TIME_SEPARATOR_SP);
    ...
    private final synchronized boolean zzb(String str) {
        synchronized (this.zzc) {
            ...
            if (!zza2.startsWith(valueOf.length() != 0 ? Constants.ACCEPT_TIME_SEPARATOR_SP.concat(valueOf) : new String(Constants.ACCEPT_TIME_SEPARATOR_SP))) {
                return false;
            }
            String valueOf2 = String.valueOf(str);
            this.zzc.zza(zza2.substring((valueOf2.length() != 0 ? Constants.ACCEPT_TIME_SEPARATOR_SP.concat(valueOf2) : new String(Constants.ACCEPT_TIME_SEPARATOR_SP)).length()));
            return true;
        }
    }
