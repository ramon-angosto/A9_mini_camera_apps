...
public final class ConnectionResult extends AbstractSafeParcelable {
    ...
    public final String toString() {
        return Objects.toStringHelper(this).add(HiAnalyticsConstant.HaKey.BI_KEY_RESULT, zza(this.zzh)).add(CommonCode.MapKey.HAS_RESOLUTION, this.zzi).add(CrashHianalyticsData.MESSAGE, this.zzj).toString();
    }
