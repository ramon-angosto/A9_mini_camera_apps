...
public class ViewPager extends ViewGroup {
    ...
    public void setAdapter(PagerAdapter pagerAdapter) {
        ...
        if (pagerAdapter2 != null) {
            ...
            for (int i = 0; i < this.mItems.size(); i++) {
                ...
                this.mAdapter.destroyItem((ViewGroup) this, itemInfo.position, itemInfo.f3988object);
            }
    ...
    public ItemInfo addNewItem(int i, int i2) {
        ...
        itemInfo.position = i;
        itemInfo.f3988object = this.mAdapter.instantiateItem((ViewGroup) this, i);
    ...
    public void dataSetChanged() {
        ...
        while (i2 < this.mItems.size()) {
            ...
            int itemPosition = this.mAdapter.getItemPosition(itemInfo.f3988object);
            if (itemPosition != -1) {
                if (itemPosition == -2) {
    ...
    public void populate(int r18) {
        ...
        L_0x00af:
            ...
            java.lang.Object r11 = r11.f3988object
        ...
        L_0x0139:
            ...
            java.lang.Object r5 = r5.f3988object
        ...
        L_0x0196:
            ...
            androidx.viewpager.widget.PagerAdapter r1 = r0.mAdapter
            int r2 = r0.mCurItem
            java.lang.Object r3 = r8.f3988object
    ...
    public ItemInfo infoForChild(View view) {
        for (int i = 0; i < this.mItems.size(); i++) {
            ItemInfo itemInfo = this.mItems.get(i);
            if (this.mAdapter.isViewFromObject(view, itemInfo.f3988object)) {
                return itemInfo;
            }
        }
        return null;
