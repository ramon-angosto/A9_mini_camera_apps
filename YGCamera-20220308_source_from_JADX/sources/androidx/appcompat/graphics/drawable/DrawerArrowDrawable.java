...
public class DrawerArrowDrawable extends Drawable {
    ...
    public DrawerArrowDrawable(Context context) {
        ...
        TypedArray obtainStyledAttributes = context.getTheme().obtainStyledAttributes((AttributeSet) null, C0039R.styleable.DrawerArrowToggle, C0039R.attr.drawerArrowStyle, C0039R.style.Base_Widget_AppCompat_DrawerArrowToggle);
