...
public class ActivityChooserView extends ViewGroup implements ActivityChooserModel.ActivityChooserModelClient {
    ...
    public ActivityChooserView(Context context, AttributeSet attributeSet, int i) {
        ...
        this.mActivityChooserContent = findViewById(C0039R.C0041id.activity_chooser_view_content);
        this.mActivityChooserContentBackground = this.mActivityChooserContent.getBackground();
        this.mDefaultActivityButton = (FrameLayout) findViewById(C0039R.C0041id.default_activity_button);
        ...
        FrameLayout frameLayout = (FrameLayout) findViewById(C0039R.C0041id.expand_activities_button);
        ...
        this.mExpandActivityOverflowButtonImage = (ImageView) frameLayout.findViewById(C0039R.C0041id.image);
    ...
    private class ActivityChooserViewAdapter extends BaseAdapter {
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            ...
            if (itemViewType == 0) {
                ...
                View inflate = LayoutInflater.from(ActivityChooserView.this.getContext()).inflate(C0039R.layout.abc_activity_chooser_view_list_item, viewGroup, false);
                inflate.setId(1);
                ((TextView) inflate.findViewById(C0039R.C0041id.title)).setText(ActivityChooserView.this.getContext().getString(C0039R.string.abc_activity_chooser_view_see_all));
                return inflate;
            }
        }
