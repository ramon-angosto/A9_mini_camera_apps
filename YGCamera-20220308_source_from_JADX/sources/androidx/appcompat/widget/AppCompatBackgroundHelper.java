    ...
    public void loadFromAttributes(AttributeSet attributeSet, int i) {
        ...
        try {
            ...
            if (obtainStyledAttributes.hasValue(C0039R.styleable.ViewBackgroundHelper_backgroundTintMode)) {
                ViewCompat.setBackgroundTintMode(this.mView, DrawableUtils.parseTintMode(obtainStyledAttributes.getInt(C0039R.styleable.ViewBackgroundHelper_backgroundTintMode, -1), (PorterDuff.Mode) null));
            }
        } finally {
