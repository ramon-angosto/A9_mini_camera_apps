...
class AlertController {
    ...
    public AlertController(Context context, AppCompatDialog appCompatDialog, Window window) {
        ...
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes((AttributeSet) null, C0039R.styleable.AlertDialog, C0039R.attr.alertDialogStyle, 0);
    ...
    private void setupView() {
        ...
        View findViewById;
        View findViewById2;
        View findViewById3 = this.mWindow.findViewById(C0039R.C0041id.parentPanel);
        View findViewById4 = findViewById3.findViewById(C0039R.C0041id.topPanel);
        View findViewById5 = findViewById3.findViewById(C0039R.C0041id.contentPanel);
        View findViewById6 = findViewById3.findViewById(C0039R.C0041id.buttonPanel);
        ViewGroup viewGroup = (ViewGroup) findViewById3.findViewById(C0039R.C0041id.customPanel);
        setupCustomContent(viewGroup);
        View findViewById7 = viewGroup.findViewById(C0039R.C0041id.topPanel);
        View findViewById8 = viewGroup.findViewById(C0039R.C0041id.contentPanel);
        View findViewById9 = viewGroup.findViewById(C0039R.C0041id.buttonPanel);
        ...
        if (!(z3 || resolvePanel2 == null || (findViewById2 = resolvePanel2.findViewById(C0039R.C0041id.textSpacerNoButtons)) == null)) {
        ...
        } else if (!(resolvePanel2 == null || (findViewById = resolvePanel2.findViewById(C0039R.C0041id.textSpacerNoTitle)) == null)) {
    ...
    private void setScrollIndicators(ViewGroup viewGroup, View view, int i, int i2) {
        ...
        View findViewById2 = this.mWindow.findViewById(C0039R.C0041id.scrollIndicatorDown);
    ...
    private void setupTitle(ViewGroup viewGroup) {
        ...
        this.mTitleView = (TextView) this.mWindow.findViewById(C0039R.C0041id.alertTitle);
    ...
    private void setupContent(ViewGroup viewGroup) {
        this.mScrollView = (NestedScrollView) this.mWindow.findViewById(C0039R.C0041id.scrollView);
