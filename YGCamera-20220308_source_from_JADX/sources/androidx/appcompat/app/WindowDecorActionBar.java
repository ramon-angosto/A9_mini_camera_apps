...
public class WindowDecorActionBar extends ActionBar implements ActionBarOverlayLayout.ActionBarVisibilityCallback {
    ...
    private void init(View view) {
        this.mOverlayLayout = (ActionBarOverlayLayout) view.findViewById(C0039R.C0041id.decor_content_parent);
        ...
        this.mContainerView = (ActionBarContainer) view.findViewById(C0039R.C0041id.action_bar_container);
        ...
        TypedArray obtainStyledAttributes = this.mContext.obtainStyledAttributes((AttributeSet) null, C0039R.styleable.ActionBar, C0039R.attr.actionBarStyle, 0);
