...
import androidx.constraintlayout.widget.C0146R;
...
public class ConstraintSet {
    ...
    static {
        mapToConstant.append(C0146R.styleable.ConstraintSet_layout_constraintLeft_toLeftOf, 25);
    ...
    private int[] convertReferenceString(View view, String str) {
        ...
        while (i2 < split.length) {
            ...
            try {
                i = C0146R.C0147id.class.getField(trim).getInt((Object) null);
