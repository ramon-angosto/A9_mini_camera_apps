...
public class FontsContractCompat {
    ...
    private static final Comparator<byte[]> sByteArrayComparator = new Comparator<byte[]>() {
        ...
        public int compare(byte[] r5, byte[] r6) {
            ...
            L_0x001b:
                return r0
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.core.provider.FontsContractCompat.C01815.compare(byte[], byte[]):int");
        }
    };
    ...
    static FontInfo[] getFontFromProvider(Context context, FontRequest fontRequest, String str, CancellationSignal cancellationSignal) {
        ...
        String str2 = str;
        ArrayList arrayList = new ArrayList();
        Uri build = new Uri.Builder().scheme(RemoteMessageConst.Notification.CONTENT).authority(str2).build();
        Uri build2 = new Uri.Builder().scheme(RemoteMessageConst.Notification.CONTENT).authority(str2).appendPath("file").build();
        Cursor cursor = null;
        try {
            ...
            if (cursor != null && cursor.getCount() > 0) {
                ...
                while (cursor.moveToNext()) {
                    ...
                    arrayList2.add(new FontInfo(uri, i2, columnIndex5 != -1 ? cursor.getInt(columnIndex5) : AGCServerException.AUTHENTICATION_INVALID, columnIndex6 != -1 && cursor.getInt(columnIndex6) == 1, i));
                }
