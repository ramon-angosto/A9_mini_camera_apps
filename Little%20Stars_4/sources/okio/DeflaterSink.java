...
public final class DeflaterSink implements Sink {
    ...
    private void deflate(boolean z) throws IOException {
        ...
        while (true) {
            ...
            if (z) {
                i = this.deflater.deflate(writableSegment.data, writableSegment.limit, 2048 - writableSegment.limit, 2);
            } else {
                i = this.deflater.deflate(writableSegment.data, writableSegment.limit, 2048 - writableSegment.limit);
            }
            if (i > 0) {
