...
public class z implements Serializable, Cloneable, org.apache.thrift.a<z, a> {
    ...
    static {
        ...
        enumMap.put(a.REQUEST, new b("request", (byte) 2, new f((byte) 12, y.class)));
    ...
    public void a(org.apache.thrift.protocol.e r5) {
        ...
        L_0x0061:
            byte r1 = r0.b
            if (r1 != r2) goto L_0x001b
            com.xiaomi.xmpush.thrift.y r0 = new com.xiaomi.xmpush.thrift.y
            r0.<init>()
            r4.e = r0
            com.xiaomi.xmpush.thrift.y r0 = r4.e
    ...
    public boolean a(z zVar) {
        ...
        boolean d2 = d();
        boolean d3 = zVar.d();
        if ((d2 || d3) && (!d2 || !d3 || !this.d.equals(zVar.d))) {
            return false;
        }
        boolean e2 = e();
        boolean e3 = zVar.e();
        if ((e2 || e3) && (!e2 || !e3 || !this.e.a(zVar.e))) {
            return false;
        }
        boolean f2 = f();
        boolean f3 = zVar.f();
        if ((f2 || f3) && (!f2 || !f3 || this.f != zVar.f)) {
            return false;
        }
        boolean g2 = g();
        boolean g3 = zVar.g();
        ...
        boolean i2 = i();
        boolean i3 = zVar.i();
        if ((i2 || i3) && (!i2 || !i3 || !this.h.equals(zVar.h))) {
            return false;
        }
        boolean j2 = j();
        boolean j3 = zVar.j();
        if ((j2 || j3) && (!j2 || !j3 || !this.i.equals(zVar.i))) {
            return false;
        }
        boolean l2 = l();
        boolean l3 = zVar.l();
        if (l2 || l3) {
            return l2 && l3 && this.j.equals(zVar.j);
        }
        return true;
    }
    ...
    public int compareTo(z zVar) {
        ...
        if (a() && (a11 = org.apache.thrift.b.a(this.a, zVar.a)) != 0) {
            return a11;
        }
        ...
        if (b() && (a10 = org.apache.thrift.b.a((Comparable) this.b, (Comparable) zVar.b)) != 0) {
            return a10;
        }
        ...
        if (c() && (a9 = org.apache.thrift.b.a(this.c, zVar.c)) != 0) {
            return a9;
        }
        ...
        if (d() && (a8 = org.apache.thrift.b.a(this.d, zVar.d)) != 0) {
            return a8;
        }
        ...
        if (e() && (a7 = org.apache.thrift.b.a((Comparable) this.e, (Comparable) zVar.e)) != 0) {
            return a7;
        }
        ...
        if (f() && (a6 = org.apache.thrift.b.a(this.f, zVar.f)) != 0) {
            return a6;
        }
        ...
        if (g() && (a5 = org.apache.thrift.b.a(this.g, zVar.g)) != 0) {
            return a5;
        }
        int compareTo8 = Boolean.valueOf(i()).compareTo(Boolean.valueOf(zVar.i()));
        if (compareTo8 != 0) {
            return compareTo8;
        }
        if (i() && (a4 = org.apache.thrift.b.a(this.h, zVar.h)) != 0) {
            return a4;
        }
        int compareTo9 = Boolean.valueOf(j()).compareTo(Boolean.valueOf(zVar.j()));
        if (compareTo9 != 0) {
            return compareTo9;
        }
        if (j() && (a3 = org.apache.thrift.b.a(this.i, zVar.i)) != 0) {
            return a3;
        }
        int compareTo10 = Boolean.valueOf(l()).compareTo(Boolean.valueOf(zVar.l()));
        if (compareTo10 != 0) {
            return compareTo10;
        }
        if (!l() || (a2 = org.apache.thrift.b.a(this.j, zVar.j)) == 0) {
            return 0;
        }
        return a2;
    }
