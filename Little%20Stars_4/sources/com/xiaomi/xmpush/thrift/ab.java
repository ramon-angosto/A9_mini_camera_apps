...
public class ab implements Serializable, Cloneable, org.apache.thrift.a<ab, a> {
    ...
    static {
        ...
        enumMap.put(a.REQUEST, new b("request", (byte) 2, new f((byte) 12, aa.class)));
    ...
    public void a(org.apache.thrift.protocol.e r5) {
        ...
        L_0x006a:
            byte r1 = r0.b
            if (r1 != r2) goto L_0x003c
            com.xiaomi.xmpush.thrift.aa r0 = new com.xiaomi.xmpush.thrift.aa
            r0.<init>()
            r4.e = r0
            com.xiaomi.xmpush.thrift.aa r0 = r4.e
    ...
    public boolean a(ab abVar) {
        ...
        boolean e2 = e();
        boolean e3 = abVar.e();
        if (((e2 || e3) && (!e2 || !e3 || !this.e.a(abVar.e))) || this.f != abVar.f) {
            return false;
        }
        boolean g2 = g();
        boolean g3 = abVar.g();
        if ((g2 || g3) && (!g2 || !g3 || !this.g.equals(abVar.g))) {
            return false;
        }
        boolean h2 = h();
        boolean h3 = abVar.h();
        if (h2 || h3) {
            return h2 && h3 && this.h.equals(abVar.h);
        }
        return true;
    }
    ...
    public int compareTo(ab abVar) {
        ...
        if (a() && (a9 = org.apache.thrift.b.a(this.a, abVar.a)) != 0) {
            return a9;
        }
        ...
        if (b() && (a8 = org.apache.thrift.b.a((Comparable) this.b, (Comparable) abVar.b)) != 0) {
            return a8;
        }
        ...
        if (c() && (a7 = org.apache.thrift.b.a(this.c, abVar.c)) != 0) {
            return a7;
        }
        ...
        if (d() && (a6 = org.apache.thrift.b.a(this.d, abVar.d)) != 0) {
            return a6;
        }
        int compareTo5 = Boolean.valueOf(e()).compareTo(Boolean.valueOf(abVar.e()));
        if (compareTo5 != 0) {
            return compareTo5;
        }
        if (e() && (a5 = org.apache.thrift.b.a((Comparable) this.e, (Comparable) abVar.e)) != 0) {
            return a5;
        }
        int compareTo6 = Boolean.valueOf(f()).compareTo(Boolean.valueOf(abVar.f()));
        if (compareTo6 != 0) {
            return compareTo6;
        }
        if (f() && (a4 = org.apache.thrift.b.a(this.f, abVar.f)) != 0) {
            return a4;
        }
        int compareTo7 = Boolean.valueOf(g()).compareTo(Boolean.valueOf(abVar.g()));
        if (compareTo7 != 0) {
            return compareTo7;
        }
        if (g() && (a3 = org.apache.thrift.b.a(this.g, abVar.g)) != 0) {
            return a3;
        }
        int compareTo8 = Boolean.valueOf(h()).compareTo(Boolean.valueOf(abVar.h()));
        if (compareTo8 != 0) {
            return compareTo8;
        }
        if (!h() || (a2 = org.apache.thrift.b.a(this.h, abVar.h)) == 0) {
            return 0;
        }
        return a2;
    }
