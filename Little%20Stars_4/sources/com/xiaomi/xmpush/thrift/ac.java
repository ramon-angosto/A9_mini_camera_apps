...
public class ac implements Serializable, Cloneable, org.apache.thrift.a<ac, a> {
    ...
    public void a(org.apache.thrift.protocol.e r4) {
        ...
        L_0x0073:
            ...
            goto L_0x0003
        */
        throw new UnsupportedOperationException("Method not decompiled: com.xiaomi.xmpush.thrift.ac.a(org.apache.thrift.protocol.e):void");
    }
    ...
    public boolean a(ac acVar) {
        ...
        boolean a2 = a();
        boolean a3 = acVar.a();
        if ((a2 || a3) && (!a2 || !a3 || !this.a.equals(acVar.a))) {
            return false;
        }
        boolean b2 = b();
        boolean b3 = acVar.b();
        if ((b2 || b3) && (!b2 || !b3 || !this.b.a(acVar.b))) {
            return false;
        }
        boolean c2 = c();
        boolean c3 = acVar.c();
        if ((c2 || c3) && (!c2 || !c3 || !this.c.equals(acVar.c))) {
            return false;
        }
        boolean d2 = d();
        boolean d3 = acVar.d();
        if ((d2 || d3) && (!d2 || !d3 || !this.d.equals(acVar.d))) {
            return false;
        }
        boolean e2 = e();
        boolean e3 = acVar.e();
        if ((e2 || e3) && (!e2 || !e3 || !this.e.equals(acVar.e))) {
            return false;
        }
        boolean f2 = f();
        boolean f3 = acVar.f();
        if ((f2 || f3) && (!f2 || !f3 || !this.f.equals(acVar.f))) {
            return false;
        }
        boolean g2 = g();
        boolean g3 = acVar.g();
        if (g2 || g3) {
            return g2 && g3 && this.g.equals(acVar.g);
        }
        return true;
    }
    ...
    public int compareTo(ac acVar) {
        ...
        if (a() && (a8 = org.apache.thrift.b.a(this.a, acVar.a)) != 0) {
            return a8;
        }
        ...
        if (b() && (a7 = org.apache.thrift.b.a((Comparable) this.b, (Comparable) acVar.b)) != 0) {
            return a7;
        }
        ...
        if (c() && (a6 = org.apache.thrift.b.a(this.c, acVar.c)) != 0) {
            return a6;
        }
        int compareTo4 = Boolean.valueOf(d()).compareTo(Boolean.valueOf(acVar.d()));
        if (compareTo4 != 0) {
            return compareTo4;
        }
        if (d() && (a5 = org.apache.thrift.b.a(this.d, acVar.d)) != 0) {
            return a5;
        }
        ...
        if (e() && (a4 = org.apache.thrift.b.a(this.e, acVar.e)) != 0) {
            return a4;
        }
        int compareTo6 = Boolean.valueOf(f()).compareTo(Boolean.valueOf(acVar.f()));
        if (compareTo6 != 0) {
            return compareTo6;
        }
        if (f() && (a3 = org.apache.thrift.b.a(this.f, acVar.f)) != 0) {
            return a3;
        }
        int compareTo7 = Boolean.valueOf(g()).compareTo(Boolean.valueOf(acVar.g()));
        if (compareTo7 != 0) {
            return compareTo7;
        }
        if (!g() || (a2 = org.apache.thrift.b.a(this.g, acVar.g)) == 0) {
            return 0;
        }
        return a2;
    }
