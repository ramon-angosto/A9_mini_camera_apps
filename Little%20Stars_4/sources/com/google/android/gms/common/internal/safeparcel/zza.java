...
public class zza {
    ...
    public static class C0002zza extends RuntimeException {
        /* JADX WARNING: Illegal instructions before constructor call */
        /* Code decompiled incorrectly, please refer to instructions dump. */
        public C0002zza(java.lang.String r4, android.os.Parcel r5) {
            /*
                r3 = this;
                ...
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.common.internal.safeparcel.zza.C0002zza.<init>(java.lang.String, android.os.Parcel):void");
        }
    }
    ...
    private static void zza(Parcel parcel, int i, int i2) {
        ...
        if (zza != i2) {
            ...
            sb.append(valueOf);
            sb.append(")");
            throw new C0002zza(sb.toString(), parcel);
        }
    }
    ...
    public static int zzaq(Parcel parcel) {
        ...
        if (zzcj(zzap) != 20293) {
            ...
            throw new C0002zza(valueOf.length() != 0 ? "Expected object header. Got 0x".concat(valueOf) : new String("Expected object header. Got 0x"), parcel);
        }
