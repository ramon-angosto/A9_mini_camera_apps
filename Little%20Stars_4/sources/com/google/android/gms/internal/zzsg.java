...
public interface zzsg extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzsg {
        ...
        /* renamed from: com.google.android.gms.internal.zzsg$zza$zza  reason: collision with other inner class name */
        private static class C0027zza implements zzsg {
        ...
        public static zzsg asInterface(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzsg)) ? new C0027zza(iBinder) : (zzsg) queryLocalInterface;
        }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            if (i == 1) {
                ...
                init(zzd.zza.zzbz(parcel.readStrongBinder()));
