...
public final class zzamk {
    private static void zza(String str, Object obj, StringBuffer stringBuffer, StringBuffer stringBuffer2) throws IllegalAccessException, InvocationTargetException {
        ...
        if (obj != null) {
            if (obj instanceof zzamj) {
                ...
                String zzja = zzja(str);
                stringBuffer2.append(stringBuffer);
                stringBuffer2.append(zzja);
                stringBuffer2.append(": ");
                if (obj instanceof String) {
                    String zzcw = zzcw((String) obj);
                    stringBuffer2.append("\"");
                    stringBuffer2.append(zzcw);
                    stringBuffer2.append("\"");
    ...
    private static String zzcw(String str) {
        if (!str.startsWith("http") && str.length() > 200) {
            str = String.valueOf(str.substring(0, MKEvent.ERROR_LOCATION_FAILED)).concat("[...]");
        }
        return zzdu(str);
    }
