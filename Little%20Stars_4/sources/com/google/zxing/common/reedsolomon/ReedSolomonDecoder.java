...
public final class ReedSolomonDecoder {
    ...
    public void decode(int[] iArr, int i) throws ReedSolomonException {
        ...
        for (int i3 = 0; i3 < i; i3++) {
            int evaluateAt = genericGFPoly.evaluateAt(this.field.exp(equals ? i3 + 1 : i3));
    ...
    private GenericGFPoly[] runEuclideanAlgorithm(GenericGFPoly genericGFPoly, GenericGFPoly genericGFPoly2, int i) throws ReedSolomonException {
        ...
        GenericGFPoly genericGFPoly8 = zero2;
        ...
        while (genericGFPoly6.getDegree() >= i / 2) {
            if (!genericGFPoly6.isZero()) {
                ...
                genericGFPoly7 = zero3.multiply(genericGFPoly7).addOrSubtract(one);
                one = genericGFPoly10;
                GenericGFPoly genericGFPoly11 = one2;
                one2 = zero3.multiply(one2).addOrSubtract(genericGFPoly8);
                genericGFPoly8 = genericGFPoly11;
            } else {
        ...
        if (coefficient != 0) {
            ...
            return new GenericGFPoly[]{one2.multiply(inverse2), genericGFPoly6.multiply(inverse2)};
        }
