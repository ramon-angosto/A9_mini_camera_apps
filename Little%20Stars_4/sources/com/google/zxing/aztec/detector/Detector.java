...
public final class Detector {
    ...
    private ResultPoint[] getMatrixCornerPoints(Point[] pointArr) throws NotFoundException {
        int i = this.nbLayers;
        float f = ((float) (((i * 2) + (i > 4 ? 1 : 0)) + ((this.nbLayers - 4) / 8))) / (((float) this.nbCenterLayers) * 2.0f);
        ...
        int i6 = i5 + (i5 > 0 ? 1 : -1);
        float f2 = ((float) i4) * f;
        int round = round(((float) pointArr[2].x) - f2);
        float f3 = ((float) i6) * f;
        int round2 = round(((float) pointArr[2].y) - f3);
        int round3 = round(((float) pointArr[0].x) + f2);
        int round4 = round(((float) pointArr[0].y) + f3);
        ...
        int i10 = i9 + i3;
        float f4 = ((float) i8) * f;
        int round5 = round(((float) pointArr[3].x) - f4);
        float f5 = f * ((float) i10);
        int round6 = round(((float) pointArr[3].y) - f5);
        int round7 = round(((float) pointArr[1].x) + f4);
        int round8 = round(((float) pointArr[1].y) + f5);
    ...
    private Point[] getBullEyeCornerPoints(Point point) throws NotFoundException {
        ...
        if (i == 5 || i == 7) {
            ...
            float f2 = ((float) i2) * f;
            int round = round(((float) point4.x) - f2);
            float f3 = ((float) i3) * f;
            int round2 = round(((float) point4.y) - f3);
            int round3 = round(((float) point2.x) + f2);
            int round4 = round(((float) point2.y) + f3);
            int i4 = point3.x - point5.x;
            int i5 = point3.y - point5.y;
            float f4 = ((float) i4) * f;
            int round5 = round(((float) point5.x) - f4);
            float f5 = f * ((float) i5);
            int round6 = round(((float) point5.y) - f5);
            int round7 = round(((float) point3.x) + f4);
            int round8 = round(((float) point3.y) + f5);
            if (!isValid(round3, round4) || !isValid(round7, round8) || !isValid(round, round2) || !isValid(round5, round6)) {
                throw NotFoundException.getNotFoundInstance();
            }
    ...
    private Point getMatrixCenter() {
        ...
        int round = round((((resultPoint3.getX() + resultPoint4.getX()) + resultPoint2.getX()) + resultPoint.getX()) / 4.0f);
        int round2 = round((((resultPoint3.getY() + resultPoint4.getY()) + resultPoint2.getY()) + resultPoint.getY()) / 4.0f);
        try {
        ...
        return new Point(round((((resultPoint6.getX() + resultPoint8.getX()) + resultPoint5.getX()) + resultPoint7.getX()) / 4.0f), round((((resultPoint6.getY() + resultPoint8.getY()) + resultPoint5.getY()) + resultPoint7.getY()) / 4.0f));
    }
