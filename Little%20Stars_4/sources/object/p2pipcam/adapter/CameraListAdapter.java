...
import shix.ihdbell.project.IpcamClientActivity;
...
public class CameraListAdapter extends BaseAdapter {
    ...
    public IpcamClientActivity ipcamClientActivity;
    public boolean isSearching = false;
    private LayoutInflater listContainer = null;
    LogUtils logUtils = LogUtils.setLogger(CameraListAdapter.class);
    ...
    public CameraListAdapter(Context context2, IpcamClientActivity ipcamClientActivity2) {
        this.ipcamClientActivity = ipcamClientActivity2;
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        synchronized (this) {
            ...
            if (view == null) {
                ...
                if (cameraParamsBean.getIndex1() == 1) {
                ...
                CameraListItem cameraListItem3 = cameraListItem2;
                view2 = view;
                cameraListItem = cameraListItem3;
            }
            ...
            cameraListItem.devStatus.setTextColor(i3);
        }
        return view2;
    }
    ...
    private class MyOnTouchLister implements View.OnTouchListener {
        ...
        public boolean onTouch(View view, MotionEvent motionEvent) {
            IpcamClientActivity.changerCameraStatus(SystemValue.arrayList.get(this.position).getStatus());
            return false;
        }
    }
    ...
    private class MyOnTouchListener implements View.OnTouchListener {
        ...
        public boolean onTouch(View view, MotionEvent motionEvent) {
            if (motionEvent.getAction() != 1 || CameraListAdapter.this.ipcamClientActivity == null) {
                return false;
            }
