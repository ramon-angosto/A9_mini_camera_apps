...
public class AllRemoteVideoListAdapter extends BaseAdapter {
    private int count = 0;
    private LayoutInflater inflater = null;
    private LinearLayout layout = null;
    LogUtils logUtils = LogUtils.setLogger(AllRemoteVideoListAdapter.class);
    ...
    public AllRemoteVideoListAdapter(Context context, List<MovieInfo> list, int i) {
        this.plays = list;
