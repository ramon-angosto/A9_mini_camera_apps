...
public class ViewPager extends ViewGroup {
    ...
    public void setAdapter(PagerAdapter pagerAdapter) {
        ...
        if (pagerAdapter2 != null) {
            ...
            for (int i = 0; i < this.mItems.size(); i++) {
                ...
                this.mAdapter.destroyItem((ViewGroup) this, itemInfo.position, itemInfo.f0object);
            }
    ...
    public ItemInfo addNewItem(int i, int i2) {
        ...
        itemInfo.position = i;
        itemInfo.f0object = this.mAdapter.instantiateItem((ViewGroup) this, i);
    ...
    public void dataSetChanged() {
        ...
        while (i2 < this.mItems.size()) {
            ...
            int itemPosition = this.mAdapter.getItemPosition(itemInfo.f0object);
            if (itemPosition != -1) {
                if (itemPosition == -2) {
    ...
    public void populate(int r18) {
        ...
        L_0x00af:
            ...
            java.lang.Object r11 = r11.f0object
        ...
        L_0x0139:
            ...
            java.lang.Object r5 = r5.f0object
        ...
        L_0x0199:
            ...
            java.lang.Object r3 = r8.f0object
            goto L_0x01a3
        L_0x01a2:
            r3 = 0
        L_0x01a3:
        ...
        L_0x0218:
            return
        L_0x0219:
            android.content.res.Resources r1 = r17.getResources()     // Catch:{ NotFoundException -> 0x0226 }
            int r2 = r17.getId()     // Catch:{ NotFoundException -> 0x0226 }
            java.lang.String r1 = r1.getResourceName(r2)     // Catch:{ NotFoundException -> 0x0226 }
            goto L_0x022e
        L_0x0226:
            int r1 = r17.getId()
    ...
    public ItemInfo infoForChild(View view) {
        for (int i = 0; i < this.mItems.size(); i++) {
            ItemInfo itemInfo = this.mItems.get(i);
            if (this.mAdapter.isViewFromObject(view, itemInfo.f0object)) {
                return itemInfo;
            }
        }
        return null;
        ...
        if (this.mPageMargin > 0 && this.mMarginDrawable != null && this.mItems.size() > 0 && this.mAdapter != null) {
            ...
            while (i2 < i3) {
                ...
                if (((float) i4) + f2 > ((float) scrollX)) {
                    f3 = f5;
                    this.mMarginDrawable.setBounds((int) f2, this.mTopPageBounds, (int) (((float) i4) + f2 + 0.5f), this.mBottomPageBounds);
