...
public final class PrintHelper {
    ...
    private static final class PrintHelperKitkatImpl implements PrintHelperVersionImpl {
        ...
        public void printBitmap(String str, Bitmap bitmap, final OnPrintFinishCallback onPrintFinishCallback) {
            this.mPrintHelper.printBitmap(str, bitmap, (PrintHelperKitkat.OnPrintFinishCallback) onPrintFinishCallback != null ? new PrintHelperKitkat.OnPrintFinishCallback() {
        ...
        public void printBitmap(String str, Uri uri, final OnPrintFinishCallback onPrintFinishCallback) throws FileNotFoundException {
            this.mPrintHelper.printBitmap(str, uri, (PrintHelperKitkat.OnPrintFinishCallback) onPrintFinishCallback != null ? new PrintHelperKitkat.OnPrintFinishCallback() {
                public void onFinish() {
                    onPrintFinishCallback.onFinish();
                }
            } : null);
