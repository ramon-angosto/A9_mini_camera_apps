...
public class HelpActivity extends BaseActivity {
    ...
    public void onCreate(Bundle bundle) {
        ...
        this.btnBack.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                ...
                HelpActivity.this.overridePendingTransition(R.anim.out_to_right, R.anim.in_from_left);
            }
        });
        ...
        videoView.getHolder().setFixedSize(this.metric.widthPixels, i);
    }
    ...
    private void checkTwoDimension() {
        ...
        L_0x00d1:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: shix.ihdbell.project.HelpActivity.checkTwoDimension():void");
    }
}
