...
public class SystemBarTintManager {
    ...
    static {
        if (Build.VERSION.SDK_INT >= 19) {
            try {
                Method declaredMethod = Class.forName(MeizuConstants.CLS_NAME_SYSTEM_PROPERTIES).getDeclaredMethod("get", new Class[]{String.class});
    ...
    public static class SystemBarConfig {
        ...
        private boolean hasNavBar(Context context) {
            ...
            if (PushConstants.PUSH_TYPE_NOTIFY.equals(SystemBarTintManager.sNavBarOverride)) {
                return true;
            }
            return z;
        }
